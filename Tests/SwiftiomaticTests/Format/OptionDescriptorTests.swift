...
@Suite struct OptionDescriptorTests {
  ...
  private func validateDescriptorThrowsOptionsError(
    _ descriptor: OptionDescriptor,
  ...
  private func validateFromArguments<T: Equatable>(
    _ descriptor: OptionDescriptor,
    ...
    for expectation in expectations {
      do {
        ...
        #expect(
          options[keyPath: keyPath] == expectation.optionValue,
          "\(testName): Argument \(expectation.argumentValue) map to option \(expectation.optionValue)",
        )
        try descriptor.toOptions(expectation.argumentValue.uppercased(), &options)
        #expect(
          options[keyPath: keyPath] == expectation.optionValue,
          "\(testName): Argument Uppercased \(expectation.argumentValue) map to option \(expectation.optionValue)",
        )
        try descriptor.toOptions(expectation.argumentValue.capitalized, &options)
        #expect(
          options[keyPath: keyPath] == expectation.optionValue,
          "\(testName): Argument capitalized \(expectation.argumentValue) map to option \(expectation.optionValue)",
        )
      } catch {
  ...
  private func validateFromOptionalArguments<T: Equatable>(
    _ descriptor: OptionDescriptor,
    keyPath: WritableKeyPath<FormatOptions, T>,
    expectations: [OptionArgumentMapping<T>],
    ...
    for expectation in expectations {
      do {
        ...
        #expect(
          options[keyPath: keyPath] == expectation.optionValue,
          "\(testName): Argument \(expectation.argumentValue) map to option \(String(describing: expectation.optionValue))",
        )
        if testCaseVariation {
          do {
            ...
            #expect(
              options[keyPath: keyPath] == expectation.optionValue,
              "\(testName): Argument Uppercased \(expectation.argumentValue) map to option \(String(describing: expectation.optionValue))",
            )
            try descriptor.toOptions(expectation.argumentValue.capitalized, &options)
            #expect(
              options[keyPath: keyPath] == expectation.optionValue,
              "\(testName): Argument capitalized \(expectation.argumentValue) map to option \(String(describing: expectation.optionValue))",
            )
          } catch {
            Issue.record("\(testName): error: \(error)")
          }
  ...
  private func validateFromOptions<T>(
    _ descriptor: OptionDescriptor,
    keyPath: WritableKeyPath<FormatOptions, T>,
    expectations: [OptionArgumentMapping<T>],
    invalid: T? = nil,
    ...
    for item in expectations {
      ...
      #expect(
        descriptor.fromOptions(options) == item.argumentValue,
        "\(testName): Option is transformed to argument",
      )
    }
    ...
    if let invalid {
      ...
      #expect(
        descriptor.fromOptions(options) == descriptor.defaultArgument,
        "\(testName): invalid input return the default value",
      )
    }
  }
  ...
  private func validateArgumentsFreeTextType(
    _ descriptor: OptionDescriptor,
    ...
    for expectation in expectations {
      ...
      #expect(
        isValid == expectation.isValid,
        "\(testName): \(isValid) != \(expectation.isValid)",
      )
    }
  }
  ...
  @Test func indentation() {
    ...
    validateFromOptions(
      descriptor, keyPath: \FormatOptions.indent, expectations: fromOptionExpectations,
    )
    validateFromArguments(
      descriptor, keyPath: \FormatOptions.indent, expectations: fromArgumentExpectations,
    )
  ...
  @Test func fileHeader() {
    ...
    validateArgumentsFreeTextType(descriptor, expectations: validations)
    validateFromOptions(
      descriptor, keyPath: \FormatOptions.fileHeader, expectations: fromOptionExpectations,
    )
    validateFromOptionalArguments(
      descriptor, keyPath: \FormatOptions.fileHeader, expectations: fromArgumentExpectations,
      testCaseVariation: false,
    )
  }
  ...
  @Test func noSpaceOperators() {
    ...
    validateFromOptions(
      descriptor, keyPath: \FormatOptions.noSpaceOperators,
      expectations: fromOptionExpectations,
    )
    validateArgumentsFreeTextType(descriptor, expectations: validations)
  ...
  @Test func noWrapOperators() {
    ...
    validateFromOptions(
      descriptor, keyPath: \FormatOptions.noWrapOperators,
      expectations: fromOptionExpectations,
    )
    validateArgumentsFreeTextType(descriptor, expectations: validations)
    var options = FormatOptions()
  ...
  @Test func visibilityOrder() {
    let argument =
      "instanceLifecycle, beforeMarks, open, public, package, internal, private, fileprivate"
  ...
  @Test func visibilityOrderUnparseableArgument() {
    let argument =
      "_instanceLifecycle, lifecycle, open, public, package, internal, private, fileprivate"
  ...
  @Test func fileMacroCase() {
    ...
    #expect(throws: Never.self) {
      try Descriptors.preferFileMacro.toOptions(argument, &options)
    }
  }
}
