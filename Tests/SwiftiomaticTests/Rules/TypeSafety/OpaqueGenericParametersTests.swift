...
@Suite struct OpaqueGenericParametersTests {
  @Test func genericNotModifiedBelowSwift5_7() {
    let input = """
    ...
    testFormatting(
      for: input, rule: .opaqueGenericParameters, options: options,
      exclude: [.simplifyGenericConstraints],
    )
  }

  @Test func opaqueGenericParameterWithNoConstraint() {
    let input = """
      func foo<T>(_ value: T) {
          print(value)
      }
    ...
    testFormatting(
      for: input, output, rule: .opaqueGenericParameters, options: options,
      exclude: [.simplifyGenericConstraints],
    )
  }

  @Test func disableSomeAnyGenericType() {
    let input = """
      func foo<T>(_ value: T) {
          print(value)
      }
  ...
  @Test func opaqueGenericParameterWithConstraintInBracket() {
    let input = """
  ...
  @Test func opaqueGenericParameterWithConstraintsInWhereClause() {
    let input = """
  ...
  @Test func opaqueGenericParameterCanRemoveOneButNotOthers_onOneLine() {
    let input = """
  ...
  @Test func opaqueGenericParameterCanRemoveOneButNotOthers_onMultipleLines() {
    let input = """
      func foo<
          S: Baazable,
          T: Fooable,
  ...
  @Test func opaqueGenericParameterWithUnknownAssociatedTypeConstraint() {
  ...
  @Test func opaqueGenericParameterWithAssociatedTypeConformance() {
  ...
  @Test func opaqueGenericParameterWithKnownAssociatedTypeConstraint() {
  ...
  @Test func opaqueGenericParameterWithAssociatedTypeConstraint() {
    let input = """
  ...
  @Test func genericTypeUsedInMultipleParameters() {
    let input = """
  ...
  @Test func genericTypeUsedInClosureMultipleTimes() {
    let input = """
  ...
  @Test func genericTypeUsedAsReturnType() {
  ...
  @Test func genericTypeUsedAsReturnTypeAndParameter() {
  ...
  @Test func genericTypeWithClosureInWhereClauseDoesNotCrash() {
    let input = """
      struct Foo<U> {
  ...
  @Test func genericExtensionSameTypeConstraint() {
    let input = """
  ...
  @Test func genericExtensionSameTypeGenericConstraint() {
    let input = """
  ...
  @Test func variadicParameterNotConvertedToOpaqueGeneric() {
    let input = """
  ...
  @Test func nonGenericVariadicParametersDoesNotPreventUsingOpaqueGenerics() {
    let input = """
  ...
  @Test func genericSimplifiedInMethodWithAttributeOrMacro() {
    let input = """
      @MyResultBuilder
  ...
  @Test func genericThrowsTypeNotTreatedAsAny() {
    let input = """
  ...
  @Test func genericExtensionNotModifiedBeforeSwift5_7() {
    let input = """
    ...
    testFormatting(
      for: input, rule: .opaqueGenericParameters, options: options,
      exclude: [.simplifyGenericConstraints, .emptyExtensions],
    )
  }

  @Test func opaqueGenericParametersRuleSuccessfullyTerminatesInSampleCode() {
    let input = """
  ...
  @Test func genericParameterUsedInConstraintOfOtherTypeNotChanged() {
    let input = """
  ...
  @Test func genericParameterInheritedFromContextNotRemoved() {
    let input = """
      func assign<Target>(
          on _: DispatchQueue,
  ...
  @Test func genericParameterUsedInBodyNotRemoved() {
    let input = """
      func foo<T>(_ value: T) {
          typealias TTT = T
  ...
  @Test func genericParameterUsedAsClosureParameterNotRemoved() {
    let input = """
  ...
  @Test func finalGenericParamRemovedProperlyWithoutHangingComma() {
    let input = """
      func foo<Bar, Baaz>(
          bar _: (Bar) -> Void,
          baaz _: Baaz
  ...
  @Test func handlesSingleExactTypeGenericConstraint() {
    let input = """
  ...
  @Test func doesNotChangeTypeWithConstraintThatReferencesItself() {
  ...
  @Test func opaqueGenericParametersDoesNotleaveTrailingComma() {
    let input = """
    ...
    let options = FormatOptions(swiftVersion: "5.7")
    testFormatting(
      for: input, output, rule: .opaqueGenericParameters,
      options: options, exclude: [.simplifyGenericConstraints, .unusedArguments],
    )
  }

  @Test func updatesProtocolRequirements() {
    let input = """
  ...
  @Test func preservesGenericInProtocolPrimaryAssociatedType() {
