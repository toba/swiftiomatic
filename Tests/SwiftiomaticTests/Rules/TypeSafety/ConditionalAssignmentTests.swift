...
@Suite struct ConditionalAssignmentTests {
  @Test func doesNotConvertIfStatementAssignmentSwift5_8() {
    let input = """
      let foo: Foo
      if condition {
          foo = Foo("foo")
  ...
  @Test func doesNotConvertsIfStatementAssigningMultipleProperties() {
    let input = """
      let foo: Foo
      let bar: Bar
      if condition {
  ...
  @Test func doesNotConvertsIfStatementAssigningDifferentProperties() {
    let input = """
      var foo: Foo?
      var bar: Bar?
      if condition {
  ...
  @Test func doesNotConvertNonExhaustiveIfStatementAssignment1() {
    let input = """
      var foo: Foo?
      if condition {
          foo = Foo("foo")
  ...
  @Test func doesNotConvertNonExhaustiveIfStatementAssignment2() {
    let input = """
      var foo: Foo?
      if condition {
          if condition {
  ...
  @Test func doesNotConvertMultiStatementIfStatementAssignment1() {
    let input = """
      let foo: Foo
      if condition {
          foo = Foo("foo")
  ...
  @Test func doesNotConvertMultiStatementIfStatementAssignment2() {
    let input = """
      let foo: Foo
      switch condition {
      case true:
  ...
  @Test func doesNotConvertMultiStatementIfStatementAssignment3() {
    let input = """
      let foo: Foo
      if condition {
          if condition {
  ...
  @Test func doesNotConvertMultiStatementIfStatementAssignment4() {
    let input = """
      let foo: Foo
      switch condition {
      case true:
  ...
  @Test func doesNotConvertMultiStatementIfStatementWithStringLiteral() {
    let input = """
      let text: String
      if conditionOne {
          text = "Hello World!"
  ...
  @Test func doesNotConvertMultiStatementIfStatementWithCollectionLiteral() {
    let input = """
      let text: [String]
      if conditionOne {
          text = []
  ...
  @Test func doesNotConvertMultiStatementIfStatementWithIntLiteral() {
    let input = """
      let number: Int?
      if conditionOne {
          number = 5
  ...
  @Test func doesNotConvertMultiStatementIfStatementWithNilLiteral() {
    let input = """
      let number: Int?
      if conditionOne {
          number = nil
  ...
  @Test func doesNotConvertMultiStatementIfStatementWithOtherProperty() {
    let input = """
      let number: Int?
      if conditionOne {
  ...
  @Test func doesNotConvertConditionalCastInSwift5_9() {
  ...
  @Test func doesNotMergePropertyWithUnrelatedCondition() {
    let input = """
