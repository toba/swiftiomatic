...
@Suite
struct InsertBlankLineBeforeControlFlowBlocksTests: RuleTesting {

  @Test func insertsBlankBeforeForLoop() {
    assertFormatting(
      InsertBlankLineBeforeControlFlowBlocks.self,
      input: """
        func test() {
            let items = getItems()
  ...
  @Test func closingBraceAsBlankLineSkipsInsertion() {
    var config = Configuration.forTesting(enabledRule: InsertBlankLineBeforeControlFlowBlocks.self.key)
