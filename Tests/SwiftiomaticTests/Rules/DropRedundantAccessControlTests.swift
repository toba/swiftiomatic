...
@Suite
struct DropRedundantAccessControlTests: RuleTesting {

  // MARK: - RedundantInternal Tests

  @Test func redundantInternal_functionDecl() {
    assertFormatting(
      DropRedundantAccessControl.self,
      input: """
  ...
  @Test func redundantFileprivate_fileScopeFileprivateNotChanged() {
    // File-scope fileprivate is handled by UseFilePrivateForFileLocal, not this rule.
    assertFormatting(
      DropRedundantAccessControl.self,
      input: """
