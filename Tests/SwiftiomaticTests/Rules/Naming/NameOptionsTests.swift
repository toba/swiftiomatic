...
@Suite(.rulesRegistered) struct NameOptionsTests {
  typealias TesteeType = NameOptions<MockRule>
  ...
  @Test func nameConfigurationMinLengthThreshold() {
  ...
  @Test func nameConfigurationMaxLengthThreshold() {
    let nameConfig = TesteeType(
      minLengthWarning: 0,
      minLengthError: 0,
      maxLengthWarning: 17,
  ...
  @Test func unallowedSymbolsSeverity() throws {
    var nameConfig = TesteeType(
      minLengthWarning: 3,
      minLengthError: 1,
      maxLengthWarning: 17,
