...
@Suite struct ElseOnSameLineTests {
    @Test func elseOnSameLine() {
        ...
        """
        testFormatting(
            for: input, output, rule: .elseOnSameLine,
    ...
    @Test func elseOnSameLineDoesNotEatPreviousStatement() {
        let input = """
        if true {}
    ...
    @Test func elseOnSameLineInferenceEdgeCase() {
        ...
        testFormatting(
            for: input, rule: .elseOnSameLine, options: options,
            exclude: [.braces],
        )
    }
    ...
    @Test func preserveBlankLineBeforeElseDoesNotAffectOtherCases() {
        let input = """
        if foo {
            print("foo")
        }
        ...
        testFormatting(
            for: input, output, rule: .elseOnSameLine, options: options,
