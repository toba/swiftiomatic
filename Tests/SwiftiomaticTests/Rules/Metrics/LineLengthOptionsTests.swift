...
@Suite(.rulesRegistered) struct LineLengthOptionsTests {
  private let severityLevels = SeverityLevelsConfiguration<LineLengthRule>(
    warning: 100,
    error: 150,
  )

  @Test func lineLengthConfigurationInitializerSetsLength() {
    let configuration1 = LineLengthOptions(length: severityLevels)
    #expect(configuration1.length == severityLevels)

    let length2 = SeverityLevelsConfiguration<LineLengthRule>(warning: 100, error: nil)
    let configuration2 = LineLengthOptions(length: length2)
    #expect(configuration2.length == length2)
  }

  @Test func lineLengthConfigurationInitialiserSetsIgnoresURLs() {
    let configuration1 = LineLengthOptions(length: severityLevels, ignoresURLs: true)

    #expect(configuration1.ignoresURLs)

    let configuration2 = LineLengthOptions(length: severityLevels)
    #expect(!configuration2.ignoresURLs)
  }

  @Test func lineLengthConfigurationInitialiserSetsIgnoresFunctionDeclarations() {
    let configuration1 = LineLengthOptions(
      length: severityLevels, ignoresFunctionDeclarations: true,
    )
  ...
  @Test func lineLengthConfigurationInitialiserSetsIgnoresComments() {
    let configuration1 = LineLengthOptions(length: severityLevels, ignoresComments: true)
  ...
  @Test func lineLengthConfigurationInitialiserSetsIgnoresInterpolatedStrings() {
    let configuration1 = LineLengthOptions(
      length: severityLevels, ignoresInterpolatedStrings: true,
    )
  ...
  @Test func lineLengthConfigurationInitialiserSetsIgnoresMultilineStrings() {
    let configuration1 = LineLengthOptions(
      length: severityLevels, ignoresMultilineStrings: true,
    )
  ...
  @Test func lineLengthConfigurationInitialiserSetsExcludedLinesPatterns() {
    let patterns: Set = ["foo", "bar"]
    let configuration1 = LineLengthOptions(
      length: severityLevels, excludedLinesPatterns: patterns,
    )
  ...
  @Test func lineLengthConfigurationParams() {
    let warning = 13
    let error = 10
    let configuration = LineLengthOptions(
  ...
  @Test func lineLengthConfigurationPartialParams() {
    let configuration =
      LineLengthOptions(length: SeverityLevelsConfiguration(warning: 13))
  ...
  @Test func lineLengthConfigurationThrowsOnBadConfig() {
    ...
    var configuration = LineLengthOptions(length: severityLevels)
    #expect(throws: SwiftiomaticError.invalidConfiguration(ruleID: LineLengthRule.identifier)) {
      try configuration.apply(configuration: config)
    }
  }

  @Test func lineLengthConfigurationThrowsOnBadConfigValues() {
  ...
  @Test func lineLengthConfigurationApplyConfigurationWithArray() throws {
    var configuration = LineLengthOptions(
  ...
  @Test func lineLengthConfigurationApplyConfigurationWithDictionary() throws {
    var configuration = LineLengthOptions(
      length: SeverityLevelsConfiguration(warning: 0, error: 0),
    )
  ...
  @Test func lineLengthConfigurationCompares() {
    let configuration1 = LineLengthOptions(
      length: SeverityLevelsConfiguration(warning: 100, error: 100),
    )
    let configuration2 = LineLengthOptions(
      length: SeverityLevelsConfiguration(warning: 100, error: 100),
    ...
    let configuration3 = LineLengthOptions(
      length: SeverityLevelsConfiguration(warning: 100, error: 200),
    )
    #expect(configuration1 != configuration3)

    let configuration4 = LineLengthOptions(
      length: SeverityLevelsConfiguration(warning: 200, error: 200),
    )
    #expect(configuration1 != configuration4)

    let configuration5 = LineLengthOptions(
      length: SeverityLevelsConfiguration(warning: 100, error: 100),
    )
    #expect(configuration1 == configuration5)

    let configuration6 = LineLengthOptions(
      length: SeverityLevelsConfiguration(warning: 100, error: 100),
      ignoresFunctionDeclarations: true,
      ignoresComments: true,
    )
