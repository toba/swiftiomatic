...
@Suite(.rulesRegistered) struct TypeBodyLengthOptionsTests {
  @Test func defaultConfiguration() {
    let config = TypeBodyLengthOptions()
  ...
  @Test func applyingOnlyExcludedTypesConfiguration() throws {
    var config = TypeBodyLengthOptions()
    try config.apply(
      configuration: [
  ...
  @Test func applyingAllTypesAsExcludedConfiguration() throws {
    var config = TypeBodyLengthOptions()
    try config.apply(
      configuration: [
  ...
  @Test func applyingEmptyExcludedTypesConfiguration() throws {
    var config = TypeBodyLengthOptions()
    try config.apply(
      configuration: [
  ...
  @Test func applyingSingleExcludedTypeConfiguration() throws {
    var config = TypeBodyLengthOptions()
    try config.apply(
      configuration: [
  ...
  @Test func typeEnumComparability() {
    #expect(
