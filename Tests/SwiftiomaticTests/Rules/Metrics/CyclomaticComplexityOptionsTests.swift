...
@Suite(.rulesRegistered) struct CyclomaticComplexityOptionsTests {
  @Test func cyclomaticComplexityConfigurationInitializerSetsLevels() {
    ...
    let configuration1 = CyclomaticComplexityOptions(length: level)
  ...
  @Test func cyclomaticComplexityConfigurationInitializerSetsIgnoresCaseStatements() {
    ...
    let configuration2 = CyclomaticComplexityOptions(
      length: SeverityLevelsConfiguration(warning: 10, error: 30),
    )
  ...
  @Test func cyclomaticComplexityConfigurationApplyConfigurationWithDictionary() throws {
    var configuration = CyclomaticComplexityOptions(
  ...
  @Test func cyclomaticComplexityConfigurationThrowsOnBadConfigValues() {
    ...
    for badConfig in badConfigs {
      ...
      checkError(SwiftiomaticError.invalidConfiguration(ruleID: CyclomaticComplexityRule.identifier)) {
  ...
  @Test func cyclomaticComplexityConfigurationCompares() {
    let config1 = CyclomaticComplexityOptions(
      length: SeverityLevelsConfiguration(warning: 10, error: 30),
    )
    let config2 = CyclomaticComplexityOptions(
      length: SeverityLevelsConfiguration(warning: 10, error: 30),
      ignoresCaseStatements: true,
    )
    let config3 = CyclomaticComplexityOptions(
      length: SeverityLevelsConfiguration(warning: 10, error: 30),
      ignoresCaseStatements: false,
    )
    let config4 = CyclomaticComplexityOptions(
      length: SeverityLevelsConfiguration(warning: 10, error: 40),
    )
    let config5 = CyclomaticComplexityOptions(
