...
@Suite struct WrapMultilineStatementBracesTests {
  ...
  @Test func multilineFuncBraceOnNextLine() {
    ...
    let output = """
      ...
      """
    testFormatting(
      for: input, output, rule: .wrapMultilineStatementBraces,
  ...
  @Test func multilineGuardClosingBraceOnSameLine() {
    let input = """
      ...
      """
    testFormatting(
      for: input, rule: .wrapMultilineStatementBraces,
  ...
  @Test func openBraceAfterEqualsInGuardNotWrapped() {
    ...
    testFormatting(
      for: input, rules: [.wrapMultilineStatementBraces, .wrap],
  ...
  @Test func wrapMultilineStatementBraceAfterWhereClauseWithTuple() {
    ...
    testFormatting(
      for: input,
      rules: [.wrapMultilineStatementBraces, .braces],
      options: options,
    )
  }
}
