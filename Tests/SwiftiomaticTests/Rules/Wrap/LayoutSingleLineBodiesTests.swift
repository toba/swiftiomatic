...
struct SingleLineBodiesTests: RuleTesting {
    ...
    @Test func functionNotWrappedByPropertyRule() {
        // This test verifies computed property rule doesn't affect functions. With the merged rule,
        // functions DO get wrapped by the function visitor. So this test is adapted: a single-line
        // function IS wrapped by SingleLineBodies.
        assertFormatting(
            LayoutSingleLineBodies.self,
            input: """
                func foo() 1️⃣{ print("bar") }
