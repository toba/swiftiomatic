...
@Suite struct DeploymentTargetConfigurationTests {
    ...
    @Test func appliesConfigurationFromDictionary() throws {
        ...
        #expect(configuration.iOSAppExtensionDeploymentTarget == Version(platform: .iOSApplicationExtension, major: 10, minor: 1))
        ...
        #expect(configuration.iOSDeploymentTarget == Version(platform: .iOS, major: 10, minor: 1))
        #expect(configuration.iOSAppExtensionDeploymentTarget == Version(platform: .iOSApplicationExtension, major: 13, minor: 0))
        #expect(configuration.severityConfiguration.severity == .error)
        ...
        #expect(configuration.macOSAppExtensionDeploymentTarget == Version(platform: .macOSApplicationExtension, major: 10, minor: 11, patch: 3))
        #expect(configuration.severityConfiguration.severity == .error)
        ...
        #expect(configuration.iOSAppExtensionDeploymentTarget == Version(platform: .iOSApplicationExtension, major: 13, minor: 0))
        #expect(configuration.macOSDeploymentTarget == Version(platform: .macOS, major: 10, minor: 11, patch: 3))
        #expect(configuration.macOSAppExtensionDeploymentTarget == Version(platform: .macOSApplicationExtension, major: 12, minor: 4))
        #expect(configuration.severityConfiguration.severity == .error)
        ...
        #expect(configuration.tvOSAppExtensionDeploymentTarget == Version(platform: .tvOSApplicationExtension, major: 9, minor: 1))
        #expect(configuration.watchOSDeploymentTarget == Version(platform: .watchOS, major: 5))
        #expect(configuration.watchOSAppExtensionDeploymentTarget == Version(platform: .watchOSApplicationExtension, major: 2, minor: 2))
        #expect(configuration.severityConfiguration.severity == .warning)
    }

    @Test func throwsOnBadConfig() {
