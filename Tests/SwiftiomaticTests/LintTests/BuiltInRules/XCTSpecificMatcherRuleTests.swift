...
@Suite struct XCTSpecificMatcherRuleTests {
  ...
  @Test func assertNotEqual() {
    ...
    #expect(allViolations.count == 1)
    #expect(
      allViolations.first?.reason == "Prefer the specific matcher 'XCTAssertNotEqual' instead")
  }
  ...
  @Test func assertIdentical() {
    ...
    #expect(allViolations.count == 1)
    #expect(
      allViolations.first?.reason == "Prefer the specific matcher 'XCTAssertIdentical' instead")
  }
  ...
  @Test func assertNotIdentical() {
    ...
    #expect(allViolations.count == 1)
    #expect(
      allViolations.first?.reason == "Prefer the specific matcher 'XCTAssertNotIdentical' instead")
  }
