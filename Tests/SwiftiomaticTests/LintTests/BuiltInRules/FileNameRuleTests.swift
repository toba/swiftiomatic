...
@Suite struct FileNameRuleTests {
  ...
  @Test func nestedTypeSeparatorDoesntTrigger() throws {
    #expect(
      try validate(fileName: "NotificationName+Extension.swift", nestedTypeSeparator: "").isEmpty)
    #expect(
  ...
  @Test func misspelledNameDoesntTriggerWithOverride() throws {
  ...
  @Test func customSuffixPattern() throws {
    ...
    #expect(
      try validate(fileName: "BoolExtensionTests.swift", suffixPattern: "Extensions?|\\+.*").isEmpty
    )
  }
  ...
  @Test func excludedDoesntSupportRegex() throws {
    #expect(
      try validate(
        fileName: "main.swift",
        excluded: [".*"]
  ...
  @Test func excludedPathPatternsWithRegexDoesntMatch() throws {
    #expect(
      try validate(
        fileName: "main.swift",
        excluded: [],
