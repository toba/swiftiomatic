...
@Suite struct IndentationWidthRuleTests {
    ...
    @Test func firstLineIndentation() {
    ...
    @Test func mixedTabSpaceIndentation() {
    ...
    @Test func mixedTabsAndSpacesIndentation() {
        assertNoViolation(in: "firstLine\n\tsecondLine\n        thirdLine")
        assertNoViolation(in: "firstLine\n    secondLine\n\t\tthirdLine")
        assertNoViolation(in: "firstLine\n\tsecondLine\n        thirdLine\n\t\t\tfourthLine")
    }
    ...
    @Test func duplicateWarningAvoidanceMechanism() {
    ...
    @Test func ignoredCompilerDirectives() {
    ...
    @Test func includeMultilineStrings() {
        let example0 = #"""
            let x = """
                string1
                    string2
