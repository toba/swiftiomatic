...
@Suite struct StringExtensionTests {
    ...
    @Test func relativePathExpression() {
        ...
        #expect(
            "../../OtherFolder/Test" == "Root/OtherFolder/Test"
                .path(relativeTo: "Root/Folder/SubFolder"),
        )
    ...
    @Test func characterPosition() {
        ...
        for bytes in 2 ... 17 {
            #expect("s\u{1F935}\u{1F3FC}\u{200D}\u{2640}\u{FE0F}s"
                .characterPosition(of: bytes) == nil)
        }
