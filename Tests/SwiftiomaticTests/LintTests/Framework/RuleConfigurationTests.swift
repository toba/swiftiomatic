...
@Suite struct RuleConfigurationTests {
    ...
    @Test func severityLevelConfigParams() {
        ...
        #expect(severityConfig.params == [RuleParameter(severity: .error, value: 7), RuleParameter(severity: .warning, value: 17)])
    }
    ...
    @Test func regexRuleDescription() {
        ...
        #expect(regexConfig.description == RuleDescription(identifier: "regex",
                                                                name: "regex",
    ...
    @Test func computedAccessorsOrderRuleConfiguration() throws {
        ...
        #expect(RuleConfigurationDescription.from(configuration: configuration).oneLiner() == "severity: error; order: set_get")
    }
}
