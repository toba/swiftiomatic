...
@Suite struct CommandTests {
    ...
    @Test func superfluousDisableCommands() {
        #expect(violations(Example("// swiftlint:disable nesting\nprint(123)\n")).map(\.ruleIdentifier) == ["blanket_disable_command", "superfluous_disable_command"])
        #expect(violations(Example("// swiftlint:disable:next nesting\nprint(123)\n"))[0].ruleIdentifier == "superfluous_disable_command")
        #expect(violations(Example("print(123) // swiftlint:disable:this nesting\n"))[0].ruleIdentifier == "superfluous_disable_command")
        #expect(violations(Example("print(123)\n// swiftlint:disable:previous nesting\n"))[0].ruleIdentifier == "superfluous_disable_command")
    }

    @Test func disableAllOverridesSuperfluousDisableCommand() {
        #expect(violations(
                Example("""
                        print(123)
                        """)
    ...
    @Test func superfluousDisableCommandsIgnoreDelimiter() {
        ...
        #expect(violations(Example("// swiftlint:disable nesting - \(longComment)\nprint(123)\n")).map(\.ruleIdentifier) == ["blanket_disable_command", "superfluous_disable_command"])
        #expect(violations(Example("// swiftlint:disable:next nesting - Comment\nprint(123)\n"))[0]
                .ruleIdentifier == "superfluous_disable_command")
        #expect(violations(Example("print(123) // swiftlint:disable:this nesting - Comment\n"))[0]
                .ruleIdentifier == "superfluous_disable_command")
    ...
    @Test func invalidDisableCommands() {
        #expect(violations(Example("// swiftlint:disable nesting_foo\n" +
                               "print(123)\n" +
                               "// swiftlint:enable nesting_foo\n"))[0].ruleIdentifier == "superfluous_disable_command")
        #expect(violations(Example("// swiftlint:disable:next nesting_foo\nprint(123)\n"))[0]
                .ruleIdentifier == "superfluous_disable_command")
        #expect(violations(Example("print(123) // swiftlint:disable:this nesting_foo\n"))[0]
                .ruleIdentifier == "superfluous_disable_command")
        ...
        #expect(onlyNonExistentRulesViolations.filter({ $0.ruleIdentifier == "superfluous_disable_command" }).count == 4)
        #expect(onlyNonExistentRulesViolations.filter({
            $0.ruleIdentifier == "blanket_disable_command"
        }).count == 4)

        #expect(violations(Example("print(123)\n// swiftlint:disable:previous nesting_foo\n"))[0].reason == "'nesting_foo' is not a valid SwiftLint rule; remove it from the disable command")
    }

    @Test func superfluousDisableCommandsDisabled() {
        #expect(violations(Example("// swiftlint:disable superfluous_disable_command nesting\n" +
                               "print(123)\n" +
                               "// swiftlint:enable superfluous_disable_command nesting\n")) == [])
        #expect(violations(Example("// swiftlint:disable superfluous_disable_command\n" +
                               "// swiftlint:disable nesting\n" +
                               "print(123)\n" +
                               "// swiftlint:enable superfluous_disable_command nesting\n")) == [])
        #expect(violations(Example("// swiftlint:disable:next superfluous_disable_command nesting\nprint(123)\n")) == [])
        #expect(violations(Example("print(123) // swiftlint:disable:this superfluous_disable_command nesting\n")) == [])
    ...
    @Test func superfluousDisableCommandsEnabledForAnalyzer() {
