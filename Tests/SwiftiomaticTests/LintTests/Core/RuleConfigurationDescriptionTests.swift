...
@Suite struct RuleConfigurationDescriptionTests {
    ...
    private struct MockConfiguration: RuleConfiguration {
        ...
        mutating func apply(configuration: Any) throws(Issue) {
            ...
            if let value = configuration[$flag.key] { try flag.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$string.key] { try string.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$symbol.key] { try symbol.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$integer.key] { try integer.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$null.key] { try null.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$myDouble.key] { try myDouble.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$severity.key] { try severity.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$list.key] { try list.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$set.key] { try set.apply(value, ruleID: Parent.identifier) }
            if let value = configuration[$setOfDoubles.key] { try setOfDoubles.apply(value, ruleID: Parent.identifier) }
            do {
