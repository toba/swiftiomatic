...
@Suite struct StringExtensionTests {
  ...
  @Test func relativePathExpression() {
    ...
    #expect(
      "../../OtherFolder/Test" == "Root/OtherFolder/Test".path(relativeTo: "Root/Folder/SubFolder"))
  ...
  @Test func characterPosition() {
    ...
    #expect("s\u{1F935}\u{1F3FC}\u{200D}\u{2640}\u{FE0F}s".characterPosition(of: 0) == 0)
    #expect("s\u{1F935}\u{1F3FC}\u{200D}\u{2640}\u{FE0F}s".characterPosition(of: 1) == 1)
    for bytes in 2...17 {
      #expect("s\u{1F935}\u{1F3FC}\u{200D}\u{2640}\u{FE0F}s".characterPosition(of: bytes) == nil)
    }
    #expect("s\u{1F935}\u{1F3FC}\u{200D}\u{2640}\u{FE0F}s".characterPosition(of: 18) == 2)
    #expect("s\u{1F935}\u{1F3FC}\u{200D}\u{2640}\u{FE0F}s".characterPosition(of: 19) == nil)
  }
}
