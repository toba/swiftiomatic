...
@Suite struct ConditionallySourceKitFreeTests {
  init() { RuleRegistry.registerAllRulesOnce() }

  // Mock rule for testing ConditionallySourceKitFree protocol
  fileprivate struct MockConditionalRule: Rule, ConditionallySourceKitFree {
  ...
  fileprivate struct MockSourceKitFreeRule: Rule, SourceKitFreeRule {
    static let description = RuleDescription(
  ...
  fileprivate struct MockRegularRule: Rule {
    static let description = RuleDescription(
  ...
  @Test func requiresSourceKitForDifferentRuleTypes() {
  ...
  @Test func typeCheckingBehavior() {
