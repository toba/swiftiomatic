...
@Suite struct CustomRulesTests {
    ...
    @Test func customRuleConfigurationSetsCorrectlyWithMatchKinds() {
        let configDict = [
            "my_custom_rule": [
                "name": "MyCustomRule",
                "message": "Message",
        ...
        comp.excludedMatchKinds = SourceKitSyntaxKind.allKinds.subtracting([.comment])
    ...
    @Test func customRuleConfigurationSetsCorrectlyWithExcludedMatchKinds() {
        let configDict = [
            "my_custom_rule": [
                "name": "MyCustomRule",
                "message": "Message",
        ...
        comp.regex = "regex"
        comp.severityConfiguration = SeverityConfiguration(.error)
        comp.excludedMatchKinds = Set<SourceKitSyntaxKind>([.comment])
        comp.executionMode = .default
        var compRules = CustomRulesConfiguration()
        compRules.customRuleConfigurations = [comp]
        do {
    ...
    @Test func customRuleConfigurationThrows() {
        let config = 17
    ...
    @Test func customRuleConfigurationMatchKindAmbiguity() {
        let configDict = [
            "name": "MyCustomRule",
            "message": "Message",
            "regex": "regex",
    ...
    @Test func customRuleConfigurationIgnoreInvalidRules() throws {
        let configDict = [
            "my_custom_rule": [
                "name": "MyCustomRule",
                "message": "Message",
    ...
    @Test func customRulesExcludedExcludesFile() {
    ...
    @Test func regexConfigurationParsesExecutionMode() throws {
        let configDict = [
            "regex": "pattern",
    ...
    @Test func regexConfigurationParsesSourceKitMode() throws {
        let configDict = [
            "regex": "pattern",
    ...
    @Test func regexConfigurationWithoutModeIsDefault() throws {
        let configDict = [
            "regex": "pattern",
        ]
    ...
    @Test func regexConfigurationRejectsInvalidMode() {
        let configDict = [
            "regex": "pattern",
    ...
    @Test func customRulesConfigurationParsesDefaultExecutionMode() throws {
    ...
    @Test func customRulesAppliesDefaultModeToRulesWithoutExplicitMode() throws {
        let configDict: [String: Any] = [
    ...
    @Test func customRulesConfigurationRejectsInvalidDefaultMode() {
        let configDict: [String: Any] = [
    ...
    @Test func executionModeIncludedInCacheDescription() {
        var regexConfig = Configuration(identifier: "test_rule")
    ...
    @Test func executionModeAffectsHash() {
    ...
    @Test func customRuleUsesSwiftSyntaxModeWhenConfigured() throws {
    ...
    @Test func customRuleWithoutMatchKindsUsesSwiftSyntaxByDefault() throws {
    ...
    @Test func customRuleDefaultsToSourceKitWhenNoModeSpecified() throws {
        ...
        let configuration = try Swiftiomatic.Configuration(dict: [
        ...
        #expect(!(customRule.isEffectivelySourceKitFree), "Rule depends on SourceKit")
    }

    @Test func customRuleWithMatchKindsUsesSwiftSyntaxWhenConfigured() throws {
    ...
    @Test func customRuleWithKindFilteringDefaultsToSourceKit() throws {
    ...
    @Test func customRuleWithExcludedMatchKindsUsesSwiftSyntaxWithDefaultMode() throws {
        ...
        #expect(violations[1].location.character == 5) // 'foo' in foobar
    }

    @Test func swiftSyntaxModeProducesSameResultsAsSourceKitForSimpleRules() throws {
        ...
        #expect(swiftSyntaxViolations.count == 3) // Two in comments, one in string
    ...
    @Test func swiftSyntaxModeWithCaptureGroups() throws {
    ...
    @Test func swiftSyntaxModeRespectsIncludedExcludedPaths() throws {
    ...
    @Test func swiftSyntaxModeWithMatchKindsProducesCorrectResults() throws {
    ...
    @Test func swiftSyntaxModeWithExcludedKindsFiltersCorrectly() throws {
    ...
    @Test func swiftSyntaxModeWorksWithCaptureGroups() throws {
    ...
    @Test func swiftSyntaxModeRespectsSourceKitModeOverride() throws {
    ...
    @Test func swiftSyntaxModeHandlesEmptyBridging() throws {
