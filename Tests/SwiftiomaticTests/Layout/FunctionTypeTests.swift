...
import Testing
@Suite
struct FunctionTypeTests: LayoutTesting {
  ...
  @Test func functionTypeAsync() {
    ...
    assertLayout(input: input, expected: expected, linelength: 66)
  }
  ...
  @Test func functionTypeAsyncThrows() {
    ...
    assertLayout(input: input, expected: expected, linelength: 73)
  }
  ...
  @Test func functionTypeThrows() {
    ...
    assertLayout(input: input, expected: expected, linelength: 67)
  }
  ...
  @Test func functionTypeInOut() {
    ...
    assertLayout(input: input, expected: expected, linelength: 17)
  }
