...
@Suite
struct ArrayDeclTests: LayoutTesting {
  ...
  @Test func arrayOfFunctions() {
    ...
    let expected46 =
      ...
      """
    assertLayout(input: input, expected: expected46, linelength: 46)
    ...
    let expected27 =
      ...
      """
    assertLayout(input: input, expected: expected27, linelength: 27)
  }
  ...
  @Test func inlineArrayTypeSugarWhenLineLengthExceeded() {
    ...
    assertLayout(input: input, expected: expected, linelength: 5)
  }
}
