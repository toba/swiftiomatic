...
@Suite struct RedundantReturnTests {
  ...
  @Test func removeReturnInParenthesizedClosure() {
    ...
    let output = """
      ...
      """
    testFormatting(
      for: input, output, rule: .redundantReturn, exclude: [.redundantParens, .redundantClosure])
  }
  ...
  @Test func removeReturnInFunction() {
    ...
    let options = FormatOptions(swiftVersion: "5.1")
    testFormatting(
      for: input, output, rule: .redundantReturn, options: options, exclude: [.wrapFunctionBodies])
  }
  ...
  @Test func redundantIfStatementWithClosureCondition() {
    ...
    let options = FormatOptions(swiftVersion: "5.9")
    testFormatting(
      for: input, [output], rules: [.redundantReturn, .conditionalAssignment], options: options,
  ...
  @Test func redundantReturnDoesntFailToTerminateOnLongSwitch() {
    let input = """
      func test(_ value: SomeEnum) -> String {
          switch value {
          case .one:
  ...
  @Test func doesntRemoveReturnFromIfExpressionConditionalCastInSwift5_9() {
