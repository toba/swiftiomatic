...
@Suite struct DocCommentsTests {
  ...
  @Test func doesntConvertCommentBeforeConsecutivePropertiesToDocComment() {
    let input = """
  ...
  @Test func doesntConvertCommentBeforeConsecutiveEnumCasesToDocComment() {
    let input = """
      // Names of the planets
      enum PlanetNames {
          // Inner planets
  ...
  @Test func doesntConvertAnnotationCommentsToDocComments() {
    let input = """
  ...
  @Test func doesntConvertTODOCommentsToDocComments() {
    let input = """
  ...
  @Test func doesntConvertCommentAfterTODOToDocComments() {
    let input = """
      // TODO: Clean up this mess
  ...
  @Test func doesntConvertCommentBeforeTODOToDocComments() {
    let input = """
      // Something, something
      // TODO: Clean up this mess
      func doSomething() {}
