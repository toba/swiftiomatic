...
@Suite struct WrapAttributesTests {
  ...
  @Test func testableImportIsNotWrapped() {
    let input = """
  ...
  @Test func doesntWrapAvailableAttributeWithLongMessage() {
  ...
  @Test func doesntWrapComplexAttribute() {
    let input = """
      @Option(
          name: ["myArgument"],
      ...
      """
    let options = FormatOptions(
      closingParenPosition: .sameLine, varAttributes: .prevLine, storedVarAttributes: .sameLine,
      complexAttributes: .prevLine)
    testFormatting(for: input, rule: .wrapAttributes, options: options)
  }

  @Test func doesntWrapComplexMultilineAttribute() {
    let input = """
  ...
  @Test func complexAttributesException() {
    ...
    let options = FormatOptions(
      varAttributes: .sameLine, storedVarAttributes: .sameLine, computedVarAttributes: .prevLine,
