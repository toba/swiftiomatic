...
@Suite struct NoGuardInTestsTests {
  ...
  @Test func doesNotReplaceNonTestFunction() {
    let input = """
      ...
      """
    testFormatting(
      for: input, rule: .noGuardInTests, exclude: [.testSuiteAccessControl, .validateTestCases])
  }
  ...
  @Test func preservesGuardWithShadowedVariable() {
    ...
    testFormatting(
      ...
      exclude: [.blankLinesAfterGuardStatements, .elseOnSameLine, .wrapMultilineStatementBraces])
  }
