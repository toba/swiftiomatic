...
//    }
    ...
    @Test func noMistakeProtocolClassModifierForClassFunction() {
        let input = """
        protocol Foo: class {}
        func bar() {}
        """
    ...
    @Test func redundantSelfParsingBug3() {
        let input = """
    ...
    @Test func redundantSelfParsingBug4() {
        let input = """
    ...
    @Test func redundantSelfParsingBug5() {
        let input = """
        Button.primary(
            title: "Title",
    ...
    @Test func redundantSelfParsingBug6() {
        let input = """
