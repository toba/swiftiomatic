...
@Suite struct SortImportsTests {
  ...
  @Test func sortImportsDoesntMoveHeaderComment() {
    let input = """
      // header comment
  ...
  @Test func sortImportsDoesntMoveHeaderCommentFollowedByImportComment() {
    let input = """
      // header comment
  ...
  @Test func testableImportsWithTestableOnPreviousLine() {
    let input = """
      @testable
      import Foo3
      import Bar3
  ...
  @Test func testableImportsWithGroupingTestableBottom() {
    let input = """
      @testable import Bar
      import Foo
  ...
  @Test func testableImportsWithGroupingTestableTop() {
    let input = """
      @testable import Bar
      import Foo
      @testable import UIKit
