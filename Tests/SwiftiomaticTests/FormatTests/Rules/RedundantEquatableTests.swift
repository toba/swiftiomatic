...
@Suite struct RedundantEquatableTests {
  ...
  @Test func adoptsEquatableMacroOnClass() {
    ...
    testFormatting(
      for: input, [output],
      rules: [
        .redundantEquatable, .emptyBraces, .blankLinesAtEndOfScope, .wrapAttributes, .sortImports,
      ],
      options: options
    )
  }
  ...
  @Test func preservesHashableConformance() {
    ...
    testFormatting(
      for: input, [output], rules: [.redundantEquatable, .blankLinesAtEndOfScope, .wrapAttributes],
      options: options)
  }
  ...
  @Test func insertsImportBelowHeaderCommentWithNoOtherComments() {
    ...
    testFormatting(
      for: input, [output],
      rules: [
        .redundantEquatable, .blankLinesAtEndOfScope, .emptyExtensions, .wrapAttributes,
  ...
  @Test func insertsImportBelowHeaderCommentWithOtherComments() {
    ...
    testFormatting(
      ...
      rules: [
        .redundantEquatable, .blankLinesAtEndOfScope, .emptyExtensions, .wrapAttributes,
        .consecutiveBlankLines, .sortImports,
      ],
      options: options
    )
  }
  ...
  @Test func adoptsEquatableMacroOnNestedTypeWithExtension() {
    ...
    testFormatting(
      for: input, [output],
      rules: [
        .redundantEquatable, .emptyBraces, .wrapAttributes, .emptyExtensions,
        .consecutiveBlankLines,
      ], options: options)
  }
