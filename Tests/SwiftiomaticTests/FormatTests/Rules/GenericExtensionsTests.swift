...
@Suite struct GenericExtensionsTests {
  @Test func updatesArrayGenericExtensionToAngleBracketSyntax() {
    ...
    testFormatting(
      for: input, output, rule: .genericExtensions, options: options,
      exclude: [.typeSugar, .emptyExtensions])
  }
  ...
  @Test func requiresAllGenericTypesToBeProvided() {
    ...
    let options = FormatOptions(swiftVersion: "5.7")
    testFormatting(
      for: input, rule: .genericExtensions, options: options, exclude: [.emptyExtensions])
  }
  ...
  @Test func preservesOtherConstraintsInWhereClause() {
    ...
    let options = FormatOptions(swiftVersion: "5.7")
    testFormatting(
      for: input, output, rule: .genericExtensions, options: options, exclude: [.emptyExtensions])
  }
