...
@Suite struct NoForceTryInTestsTests {
  @Test func testCaseIsUpdated_for_Testing() {
    let input = """
      import Testing
  ...
  @Test func testCaseIsUpdated_for_XCTest() {
    let input = """
      import XCTest
  ...
  @Test func testHelperIsNotUpdated_for_XCTest() {
    let input = """
      import XCTest
  ...
  @Test func nonTestCaseFunction_IsNotUpdated_for_XCTest() {
    let input = """
      ...
      """
    testFormatting(
      for: input, rule: .noForceTryInTests, exclude: [.testSuiteAccessControl, .validateTestCases])
  }

  @Test func testCaseIsUpdated_for_async_test() {
    let input = """
      import Testing
  ...
  @Test func testCaseIsUpdated_for_already_throws() {
    let input = """
      import Testing
  ...
  @Test func testCaseIsUpdated_for_multiple_try_exclamationMarks() {
    let input = """
      import Testing
  ...
  @Test func testCaseIsNotUpdated_for_try_exclamationMark_in_closoure() {
    let input = """
      import Testing
  ...
  @Test func testCaseIsUpdated_for_try_exclamationMark_in_if_statement() {
    let input = """
      import Testing
