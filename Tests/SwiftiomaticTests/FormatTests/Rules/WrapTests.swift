...
@Suite struct WrapTests {
    ...
    @Test func wrapFunctionIfReturnTypeExceedsMaxWidth() {
        let input = """
    ...
    @Test func wrapFunctionIfReturnTypeExceedsMaxWidthWithXcodeIndentation() {
        let input = """
        @Test func func() -> ReturnType {
            doSomething()
            doSomething()
    ...
    @Test func wrapFunctionIfReturnTypeExceedsMaxWidth2() {
        let input = """
    ...
    @Test func wrapFunctionIfReturnTypeExceedsMaxWidth2WithXcodeIndentation() {
        let input = """
    ...
    @Test func wrapFunctionIfReturnTypeExceedsMaxWidth2WithXcodeIndentation2() {
        let input = """
    ...
    @Test func wrapFunctionIfReturnTypeExceedsMaxWidth3() {
        let input = """
    ...
    @Test func wrapFunctionIfReturnTypeExceedsMaxWidth3WithXcodeIndentation() {
        let input = """
        @Test func func() -> (Bool, String) -> String? {
            doSomething()
        }
