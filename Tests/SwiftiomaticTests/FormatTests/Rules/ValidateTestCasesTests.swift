...
@Suite struct ValidateTestCasesTests {
    ...
    @Test func xCTestPreservesOpenTestClass() {
        let input = """
    ...
    @Test func doesNotAddXCTestCaseWithExistingConformances() {
    ...
    @Test func doesNotValidateTestsWithOtherConformances() {
    ...
    @Test func doesNotAddXCTestCaseWhenBaseClassExists() {
        let input = """
    ...
    @Test func xCTestIgnoresTypesWithParameterizedInit() {
