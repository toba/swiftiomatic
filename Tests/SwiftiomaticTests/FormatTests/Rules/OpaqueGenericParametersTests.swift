...
@Suite struct OpaqueGenericParametersTests {
  ...
  @Test func genericTypeWithClosureInWhereClauseDoesntCrash() {
    let input = """
      struct Foo<U> {
  ...
  @Test func nonGenericVariadicParametersDoesntPreventUsingOpaqueGenerics() {
    let input = """
  ...
  @Test func doesntChangeTypeWithConstraintThatReferencesItself() {
  ...
  @Test func opaqueGenericParametersDoesntleaveTrailingComma() {
    let input = """
