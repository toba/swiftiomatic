...
@Suite struct OrganizeDeclarationsTests {
  ...
  @Test func organizeTypeWithOverridenFieldsInVisibilityOrder() {
    ...
    testFormatting(
      ...
      exclude: [
        .blankLinesAtStartOfScope, .blankLinesAtEndOfScope, .sortImports, .wrapPropertyBodies,
      ]
    )
  }
  ...
  @Test func customOrganizationInVisibilityOrderWithParametrizedTypeOrder() {
    ...
    testFormatting(
      ...
      options: FormatOptions(
        visibilityOrder: ["private", "internal", "public"],
        typeOrder: [
          "beforeMarks", "nestedType", "instanceLifecycle", "instanceMethod", "instanceProperty",
        ]
      ),
  ...
  @Test func customOrganizationInTypeOrder() {
    ...
    testFormatting(
      ...
      options: FormatOptions(
        ...
        typeOrder: [
          "beforeMarks", "instanceLifecycle", "instanceMethod", "nestedType", "instanceProperty",
          "overriddenMethod",
        ]
      ),
      exclude: [.blankLinesAtStartOfScope]
  ...
  @Test func sortDeclarationTypesByType() {
    ...
    testFormatting(
      ...
      options: FormatOptions(categoryMarkComment: "MARK: %c", organizationMode: .type),
      exclude: [
        .blankLinesAtEndOfScope, .blankLinesAtStartOfScope, .redundantType, .redundantClosure,
      ]
    )
  }
  ...
  @Test func doesntAttemptToUpdateMarksNotAtTopLevel() {
    let input = """
      public class Foo {
  ...
  @Test func doesntInsertMarkWhenOnlyOneCategory() {
    let input = """
      class Foo {
          var bar: Int
          var baz: Int
  ...
  @Test func doesntBreakStructSynthesizedMemberwiseInitializer() {
    let input = """
      public struct Foo {
  ...
  @Test func doesntRemoveCategorySeparatorsFromBodyNotBeingOrganized() {
    let input = """
      public struct Foo {
  ...
  @Test func parsesPropertiesWithBodies() {
    ...
    testFormatting(
      for: input, rule: .organizeDeclarations, exclude: [.redundantClosure, .wrapPropertyBodies])
  }
  ...
  @Test func doesntConflictWithOrganizeDeclarations() {
    let input = """
      // swiftformat:sort
      enum FeatureFlags {
          case barFeature
  ...
  @Test func doesntAddUnexpectedBlankLinesDueToBlankLinesWithSpaces() {
    ...
    testFormatting(
      ...
      rule: .organizeDeclarations,
      exclude: [
        .blankLinesAtStartOfScope, .blankLinesAtEndOfScope, .consecutiveBlankLines, .trailingSpace,
  ...
  @Test func swiftUIPropertyWrappersSortDoesntBreakViewSynthesizedMemberwiseInitializer() {
  ...
  @Test func belowCustomStructMarkThresholdDoesntRemoveMarks() {
    let input = """
      struct SmallStruct {
