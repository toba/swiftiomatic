...
@Suite struct ModifierOrderTests {
  ...
  @Test func modifierOrder() {
    ...
    testFormatting(
      for: input, output, rule: .modifierOrder, options: options, exclude: [.wrapPropertyBodies])
  }
  ...
  @Test func consumingModifierOrder() {
    ...
    testFormatting(
      for: input, output, rule: .modifierOrder, options: options, exclude: [.noExplicitOwnership])
  }
