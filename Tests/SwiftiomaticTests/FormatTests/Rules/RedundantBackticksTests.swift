...
@Suite struct RedundantBackticksTests {
  ...
  @Test func removeBackticksAroundGetArgument() {
    ...
    let output = """
      ...
      """
    testFormatting(
      for: input, output, rule: .redundantBackticks,
  ...
  @Test func removeBackticksAroundTrueArgument() {
    ...
    testFormatting(
      for: input, output, rule: .redundantBackticks, options: options,
  ...
  @Test func removeBackticksAroundTrueProperty() {
    ...
    let options = FormatOptions(swiftVersion: "4")
    testFormatting(
      for: input, output, rule: .redundantBackticks, options: options, exclude: [.propertyTypes])
  }
  ...
  @Test func noRemoveBackticksAroundInitPropertyInSwift5() {
    ...
    let options = FormatOptions(swiftVersion: "5")
    testFormatting(
      for: input, rule: .redundantBackticks, options: options, exclude: [.propertyTypes])
  }
