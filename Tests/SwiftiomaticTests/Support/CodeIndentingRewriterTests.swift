...
@Suite(.rulesRegistered) struct CodeIndentingRewriterTests {
  ...
  @Test func unindentDefaultStyle() {
    assertIndent(
      source: """
            if c {
                // comment
  ...
  private func assertIndent(
    source: String, indentedSource: String, style: CodeIndentingRewriter.IndentationStyle,
  ) {
