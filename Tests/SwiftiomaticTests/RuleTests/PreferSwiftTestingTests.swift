...
@Suite struct PreferSwiftTestingTests {
    @Test func convertsSimpleTestSuite() {
        ...
        testFormatting(
            for: input, [output], rules: [.preferSwiftTesting, .sortImports, .isEmpty],
            options: options,
        )
    }
    ...
    @Test func convertsSimpleXCTestHelpers() {
        let input = """
        import XCTest
    ...
    @Test func doesNotUpdateTestNameToExistingFunctionName() {
        let input = """
        import XCTest
    ...
    @Test func addsThrowingEffectIfNeeded() {
