...
@Suite struct SimplifyGenericConstraintsTests {
    ...
    @Test func doesNotAffectStructsWithoutWhereClause() {
        let input = """
        struct Foo<T: Hashable> {}
        """
        testFormatting(for: input, rule: .simplifyGenericConstraints)
    ...
    @Test func doesNotAffectStructsWithoutGenerics() {
        let input = """
        struct Foo {}
        """
        testFormatting(for: input, rule: .simplifyGenericConstraints)
    ...
    @Test func doesNotAffectWhereClauseWithOnlyConcreteTypes() {
        let input = """
    ...
    @Test func functionWithFiveGenerics() {
        ...
        """
        testFormatting(
            for: input, output, rule: .simplifyGenericConstraints, exclude: [
                .unusedArguments,
                .indent,
            ],
        )
    ...
    @Test func multilineConstraintWithQualifiedTypeName() {
        ...
        testFormatting(
            for: input,
            rule: .simplifyGenericConstraints,
            exclude: [.indent, .emptyBraces],
        )
    }
    ...
    @Test func doesNotSimplifySingleLongProtocolName() {
        ...
        """
        testFormatting(
            for: input, rule: .simplifyGenericConstraints, exclude: [
                .indent,
                .emptyBraces,
                .braces,
            ],
