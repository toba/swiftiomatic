...
@Suite(.rulesRegistered) struct LineLengthConfigurationTests {
    ...
    @Test func lineLengthConfigurationInitialiserSetsIgnoresFunctionDeclarations() {
        let configuration1 = LineLengthConfiguration(
    ...
    @Test func lineLengthConfigurationParams() {
        let warning = 13
        let error = 10
        let configuration = LineLengthConfiguration(
    ...
    @Test func lineLengthConfigurationPartialParams() {
        let configuration =
            LineLengthConfiguration(length: SeverityLevelsConfiguration(warning: 13))
