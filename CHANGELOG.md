...
- AST-level `FixIt.Change` variants for `SyntaxViolation.Correction`; trivia and node replacement ([#243](https://github.com/toba/swiftiomatic/issues/243))
...
- Adopt swift-syntax patterns to improve Swiftiomatic ([#239](https://github.com/toba/swiftiomatic/issues/239))
