...
updated_at: 2026-04-15T01:22:10Z
---
...
- [ ] Update `Configuration` decoding to accept both bool and object for each rule entry
- [ ] Move rule option lookups from top-level config to per-rule config
- [ ] Keep backward compatibility: still accept old top-level keys during decoding
- [ ] Update `dump-configuration` to emit the new format
- [ ] Update JSON schema
- [ ] Bump config version
