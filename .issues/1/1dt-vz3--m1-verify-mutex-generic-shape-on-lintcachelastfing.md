...
updated_at: 2026-04-30T19:46:49Z
parent: 6xi-be2
sync:
    github:
        issue_number: "544"
...
No code change. Verified by inspection: `LintCache.lastFingerprint` is already `Mutex<FingerprintEntry?>` — `FingerprintEntry` is a value type and stored inside the `Mutex` generic. The shape the review flagged is what we already have.
