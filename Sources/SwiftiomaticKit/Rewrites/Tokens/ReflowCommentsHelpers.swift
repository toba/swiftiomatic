...
/// Stateless helpers for the inlined `ReflowComments` rule. Lifted verbatim
/// from `Sources/SwiftiomaticKit/Rules/Comments/ReflowComments.swift` and
/// adapted to read configuration via the `Context` parameter.

func applyReflowComments(
    _ token: TokenSyntax,
    context: Context
) -> TokenSyntax {
...
private func syntacticIndentColumn(for token: TokenSyntax, context: Context) -> Int {
    var depth = 0
