...
extension AccessorBlockSyntax {
    ...
    fileprivate var getterCodeBlockItems: CodeBlockItemListSyntax {
...
private final class TokenStreamCreator: SyntaxVisitor {
    ...
    override func visit(_ node: OriginallyDefinedInAttributeArgumentsSyntax)
        -> SyntaxVisitorContinueKind
    {
    ...
    override func visit(_ node: DifferentiabilityWithRespectToArgumentSyntax)
        -> SyntaxVisitorContinueKind
    {
