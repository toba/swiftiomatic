...
package enum RuleHandling: Hashable, Sendable {
    ...
    package init(from decoder: Decoder) throws {
        ...
        default:
            throw DecodingError.dataCorruptedError(
                in: container,
                debugDescription:
                    "Invalid rule handling '\(string)'. Expected 'autoFix', 'warn', 'error', or 'off'."
            )
        }
    }
