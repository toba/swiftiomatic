...
final class DuplicateDictionaryKeys: LintSyntaxRule<LintOnlyValue>, @unchecked Sendable {
    ...
    /// Returns a normalized string for a key expression that can be statically
    /// compared, or `nil` if the key is dynamic.
...
extension Finding.Message {
    fileprivate static func duplicateKey(_ key: String) -> Finding.Message {
