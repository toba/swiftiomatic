...
struct UnusedEnumeratedRule {
  static let id = "unused_enumerated"
  static let name = "Unused Enumerated"
  static let summary = "When the index or the item is not used, `.enumerated()` can be removed."
...
extension FunctionCallExprSyntax {
  ...
  private var hasNoArguments: Bool {
    trailingClosure == nil
