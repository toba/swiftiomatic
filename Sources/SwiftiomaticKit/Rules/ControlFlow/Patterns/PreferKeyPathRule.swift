...
struct PreferKeyPathRule {
  ...
  static let id = "prefer_key_path"
  static let name = "Prefer Key Path"
  static let summary = "Use a key path argument instead of a closure with property access"
  ...
  static var corrections: [Example: Example] {
    [
      ...
      Example(
        "f { $0 }",
        configuration: extendedModeAndIgnoreIdentity,
      ):  // no change with option enabled
        Example("f { $0 }", configuration: extendedModeAndIgnoreIdentity),
