...
final class PreferSingleLinePropertyGetter: StaticFormatRule<BasicRuleValue>, @unchecked Sendable {
    ...
    static func transform(
        ...
        result.accessorBlock?.leftBrace.trailingTrivia = triviaBeforeStatements
            .trimmingSuperfluousNewlines(fromClosingBrace: false).0
        ...
        result.accessorBlock?.accessors.trailingTrivia = triviaAfterStatements
...
fileprivate extension Finding.Message {
    static let removeExtraneousGetBlock: Finding.Message =
