...
final class FlagUnusedSetterValue: LintSyntaxRule<LintOnlyValue>, @unchecked Sendable {
    ...
    override func visit(_ node: AccessorDeclSyntax) -> SyntaxVisitorContinueKind {
        ...
        diagnose(.flagUnusedSetterValue(parameterName), on: node)
        return .visitChildren
    }
...
fileprivate extension Finding.Message {
    static func flagUnusedSetterValue(_ name: String) -> Finding.Message {
