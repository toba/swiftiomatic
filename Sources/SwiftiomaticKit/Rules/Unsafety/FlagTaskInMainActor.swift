...
/// main-actor-isolated, defeating the caller's isolation guarantee. Prefer `Task.immediate` (or
...
/// silent-fallback case the rule is named for — the runtime drops main-actor isolation without a
/// diagnostic, so reviewing flagged sites is worthwhile even when the body "looks fine."
