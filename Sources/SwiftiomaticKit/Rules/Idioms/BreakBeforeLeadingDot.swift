...
final class BreakBeforeLeadingDot: StaticFormatRule<BasicRuleValue>, @unchecked Sendable {
    ...
    /// the surrounding expression layout (and in particular makes `WrapTernary` over-fire).
