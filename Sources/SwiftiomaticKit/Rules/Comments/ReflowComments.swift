...
final class ReflowComments: StaticFormatRule<BasicRuleValue>, @unchecked Sendable {
    ...
    static func reflow(_ token: TokenSyntax, context: Context) -> TokenSyntax {
        ...
        Self.diagnose(
            ...
            on: token,
            context: context,
            anchor: .leadingTrivia(triviaIdx)
        )
    ...
    private static func commentKind(of piece: TriviaPiece) -> CommentRunKind? {
        switch piece {
    ...
    private static func commentText(_ piece: TriviaPiece) -> String? {
        switch piece {
    ...
    private static func makePiece(kind: CommentRunKind, text: String) -> TriviaPiece {
        switch kind {
    ...
    private static func stripPrefix(_ text: String, kind: CommentRunKind) -> String {
    ...
    private static func indentTrivia(_ indent: String) -> [TriviaPiece] {
