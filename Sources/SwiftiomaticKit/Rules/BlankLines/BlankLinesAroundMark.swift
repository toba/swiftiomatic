...
///
/// MARK comments serve as section dividers. Surrounding them with blank lines makes the visual
/// separation clear. A blank line before MARK is skipped when the MARK immediately follows an
/// opening brace (start of scope). A blank line after MARK is skipped when the MARK immediately
/// precedes a closing brace (end of scope) or end of file.
///
...
/// `applyBlankLinesAroundMark` directly from `Rewrites/Tokens/TokenRewrites.swift` . This class
