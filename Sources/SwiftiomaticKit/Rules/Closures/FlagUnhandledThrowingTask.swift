...
final class FlagUnhandledThrowingTask: LintSyntaxRule<LintOnlyValue>, @unchecked Sendable {
    ...
    override func visit(_ node: FunctionCallExprSyntax) -> SyntaxVisitorContinueKind {
        ...
        diagnose(.flagUnhandledThrowingTask, on: node.calledExpression)
...
fileprivate extension Finding.Message {
    static let flagUnhandledThrowingTask: Finding.Message =
