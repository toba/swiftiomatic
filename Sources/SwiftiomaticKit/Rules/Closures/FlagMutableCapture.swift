...
/// warning is raised.
final class FlagMutableCapture: LintSyntaxRule<LintOnlyValue>, @unchecked Sendable {
    ...
    override func visit(_ node: ClosureCaptureSyntax) -> SyntaxVisitorContinueKind {
        ...
        diagnose(.flagMutableCapture(name), on: node.name)
        return .visitChildren
    }
}
...
fileprivate extension Finding.Message {
    static func flagMutableCapture(_ name: String) -> Finding.Message {
