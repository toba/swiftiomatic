...
final class UseAllSatisfy: LintSyntaxRule<LintOnlyValue>, @unchecked Sendable {
    ...
    override func visit(_ node: FunctionCallExprSyntax) -> SyntaxVisitorContinueKind {
        ...
        diagnose(.useAllSatisfy(isTrue: isTrue), on: member.declName)
        return .visitChildren
    }
}

fileprivate extension Finding.Message {
    static func useAllSatisfy(isTrue: Bool) -> Finding.Message {
        isTrue
