...
final class UseFlatMap: LintSyntaxRule<LintOnlyValue>, @unchecked Sendable {
    ...
    override func visit(_ node: FunctionCallExprSyntax) -> SyntaxVisitorContinueKind {
        ...
        diagnose(.useFlatMap, on: member.declName)
        return .visitChildren
    }
}

fileprivate extension Finding.Message {
    static let useFlatMap: Finding.Message = "prefer 'flatMap' over 'map { ... }.reduce([], +)'"
}
