...
final class UseMinMax: LintSyntaxRule<LintOnlyValue>, @unchecked Sendable {
    ...
    override func visit(_ node: MemberAccessExprSyntax) -> SyntaxVisitorContinueKind {
        ...
        diagnose(.useMinMax(useFirst: name == "first"), on: node.declName)
        return .visitChildren
    }
}

fileprivate extension Finding.Message {
    static func useMinMax(useFirst: Bool) -> Finding.Message {
        useFirst
