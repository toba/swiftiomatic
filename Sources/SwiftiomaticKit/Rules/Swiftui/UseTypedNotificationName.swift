...
/// Flag custom `Notification.Name` declarations —
/// `extension Notification.Name { static let foo = ... }` and `Notification.Name("...")` /
/// `Notification.Name(rawValue: "...")` literal constructions. On macOS 26 / iOS 26+, prefer a
/// `NotificationCenter.MainActorMessage` (or `AsyncMessage`) struct for type- and isolation-safety.
///
...
fileprivate extension Finding.Message {
    static let customNotificationName: Finding.Message =
