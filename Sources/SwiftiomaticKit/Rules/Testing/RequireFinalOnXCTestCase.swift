...
final class RequireFinalOnXCTestCase: LintSyntaxRule<LintOnlyValue>, @unchecked Sendable {
    ...
    override func visit(_ node: ClassDeclSyntax) -> SyntaxVisitorContinueKind {
        ...
        diagnose(.requireFinalOnXCTestCase, on: node.name)
        return .visitChildren
    }
}

fileprivate extension Finding.Message {
    static let requireFinalOnXCTestCase: Finding.Message = "test cases should be 'final'"
}
