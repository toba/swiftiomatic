...
extension Configuration {
  ...
  public final class RuleSelection: Sendable {
    ...
    private func computeResultingRules() -> [any Rule] {
      ...
      case .onlyConfiguration(let onlyRulesRuleIdentifiers),
        .onlyCommandLine(let onlyRulesRuleIdentifiers):
      ...
      case .defaultConfiguration(var disabledRuleIdentifiers, var optInRuleIdentifiers):
