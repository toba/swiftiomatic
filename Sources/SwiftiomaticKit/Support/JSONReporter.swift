    ...
    public struct Entry: Encodable, Sendable {
        ...
        public func encode(to encoder: any Encoder) throws {
            ...
            if let column {
                ...
                try container.encodeNil(forKey: .column)
            }
            ...
            if let rule {
                ...
                try container.encodeNil(forKey: .rule)
            }
...
public final class JSONFormatReporter: Sendable {
    ...
    public func recordUnchanged(file: String) { buffer.withLock { $0.unchanged.append(file) } }
