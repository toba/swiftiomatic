...
class LintPipeline: SyntaxVisitor {
  ...
  override func visitPost(_ node: AccessorBlockSyntax) {
    onVisitPost(AccessorOrder.visitPost, for: node)
  ...
  override func visitPost(_ node: AccessorDeclSyntax) {
    onVisitPost(NoLocalDocComments.visitPost, for: node)
    onVisitPost(rule: RedundantSelf.self, for: node)
    onVisitPost(UnusedSetterValue.visitPost, for: node)
  ...
  override func visitPost(_ node: ActorDeclSyntax) {
    onVisitPost(CapitalizeTypeNames.visitPost, for: node)
    onVisitPost(rule: DocCommentsPrecedeModifiers.self, for: node)
    onVisitPost(DocumentPublicDeclarations.visitPost, for: node)
    ...
    onVisitPost(NestingDepth.visitPost, for: node)
    ...
    onVisitPost(TypeBodyLength.visitPost, for: node)
  ...
  override func visitPost(_ node: AssociatedTypeDeclSyntax) {
    onVisitPost(CapitalizeTypeNames.visitPost, for: node)
    onVisitPost(rule: ModifiersOnSameLine.self, for: node)
    onVisitPost(NoLeadingUnderscores.visitPost, for: node)
    onVisitPost(RequireDocCommentSummary.visitPost, for: node)
  }
  ...
  override func visitPost(_ node: AttributeSyntax) {
    onVisitPost(NoRetroactiveConformances.visitPost, for: node)
  ...
  override func visitPost(_ node: CatchClauseSyntax) {
    ...
    onVisitPost(TypedCatchError.visitPost, for: node)
  }
  ...
  override func visitPost(_ node: ClassDeclSyntax) {
    onVisitPost(CamelCaseIdentifiers.visitPost, for: node)
    onVisitPost(CapitalizeTypeNames.visitPost, for: node)
    onVisitPost(rule: DocCommentsPrecedeModifiers.self, for: node)
    onVisitPost(DocumentPublicDeclarations.visitPost, for: node)
    onVisitPost(rule: ExtensionAccessLevel.self, for: node)
    onVisitPost(FinalTestCase.visitPost, for: node)
    onVisitPost(rule: ModifierOrder.self, for: node)
    onVisitPost(rule: ModifiersOnSameLine.self, for: node)
    onVisitPost(NestingDepth.visitPost, for: node)
  ...
  override func visitPost(_ node: ClosureCaptureSyntax) {
    onVisitPost(MutableCapture.visitPost, for: node)
  }
  ...
  override func visitPost(_ node: ClosureExprSyntax) {
    onVisitPost(ClosureBodyLength.visitPost, for: node)
  ...
  override func visitPost(_ node: CodeBlockSyntax) {
    onVisitPost(AmbiguousTrailingClosureOverload.visitPost, for: node)
  ...
  override func visitPost(_ node: DeinitializerDeclSyntax) {
    onVisitPost(DeinitObserverRemoval.visitPost, for: node)
    onVisitPost(DocumentPublicDeclarations.visitPost, for: node)
    onVisitPost(FunctionBodyLength.visitPost, for: node)
    onVisitPost(rule: ModifiersOnSameLine.self, for: node)
    onVisitPost(NoLocalDocComments.visitPost, for: node)
    onVisitPost(RequireDocCommentSummary.visitPost, for: node)
    onVisitPost(rule: TripleSlashDocComments.self, for: node)
  ...
  override func visitPost(_ node: DictionaryElementListSyntax) {
    onVisitPost(DuplicateDictionaryKeys.visitPost, for: node)
  }
  ...
  override func visitPost(_ node: EnumCaseDeclSyntax) {
    onVisitPost(AssociatedValueCount.visitPost, for: node)
    onVisitPost(rule: ModifiersOnSameLine.self, for: node)
  ...
  override func visitPost(_ node: FunctionCallExprSyntax) {
    ...
    onVisitPost(rule: NoForceUnwrap.self, for: node)
    onVisitPost(NoLiteralProtocolInit.visitPost, for: node)
    onVisitPost(NoOptionalBool.visitPost, for: node)
    onVisitPost(rule: NoTrailingClosureParens.self, for: node)
    onVisitPost(OnlyOneTrailingClosureArgument.visitPost, for: node)
    onVisitPost(PreferAllSatisfy.visitPost, for: node)
    onVisitPost(rule: PreferAssertionFailure.self, for: node)
    onVisitPost(rule: PreferDotZero.self, for: node)
    onVisitPost(PreferFailableStringInit.visitPost, for: node)
    onVisitPost(PreferFlatMap.visitPost, for: node)
    onVisitPost(rule: PreferKeyPath.self, for: node)
    onVisitPost(PreferNonOptionalDataInit.visitPost, for: node)
    onVisitPost(PreferReduceInto.visitPost, for: node)
    onVisitPost(rule: PreferSwiftTesting.self, for: node)
    ...
    onVisitPost(ReplaceForEachWithForLoop.visitPost, for: node)
    onVisitPost(rule: RequireFatalErrorMessage.self, for: node)
    onVisitPost(RetainNotificationObserver.visitPost, for: node)
    onVisitPost(UnhandledThrowingTask.visitPost, for: node)
  ...
  override func visitPost(_ node: FunctionDeclSyntax) {
    onVisitPost(CamelCaseIdentifiers.visitPost, for: node)
    onVisitPost(CyclomaticComplexity.visitPost, for: node)
    onVisitPost(rule: DocCommentsPrecedeModifiers.self, for: node)
    onVisitPost(DocumentPublicDeclarations.visitPost, for: node)
    onVisitPost(rule: ExtensionAccessLevel.self, for: node)
    onVisitPost(FunctionBodyLength.visitPost, for: node)
    ...
    onVisitPost(ParameterCount.visitPost, for: node)
    onVisitPost(rule: PreferSwiftTesting.self, for: node)
    onVisitPost(rule: RedundantAccessControl.self, for: node)
    ...
    onVisitPost(RequireDocCommentSummary.visitPost, for: node)
    onVisitPost(RequireParameterDocumentation.visitPost, for: node)
    onVisitPost(RequireSuperCall.visitPost, for: node)
    onVisitPost(rule: SimplifyGenericConstraints.self, for: node)
  ...
  override func visitPost(_ node: IdentifierPatternSyntax) {
    onVisitPost(ASCIIIdentifiers.visitPost, for: node)
    onVisitPost(NoLeadingUnderscores.visitPost, for: node)
  }
  ...
  override func visitPost(_ node: IfExprSyntax) {
    ...
    onVisitPost(DuplicateConditions.visitPost, for: node)
    onVisitPost(rule: NoParensAroundConditions.self, for: node)
  ...
  override func visitPost(_ node: LabeledStmtSyntax) {
    onVisitPost(UnusedControlFlowLabel.visitPost, for: node)
  }
  ...
  override func visitPost(_ node: MacroExpansionExprSyntax) {
    onVisitPost(NoPlaygroundLiterals.visitPost, for: node)
  ...
  override func visitPost(_ node: MemberAccessExprSyntax) {
    ...
    onVisitPost(PreferFirstWhere.visitPost, for: node)
    onVisitPost(rule: PreferIsDisjoint.self, for: node)
    onVisitPost(PreferLastWhere.visitPost, for: node)
    onVisitPost(PreferMinMax.visitPost, for: node)
    onVisitPost(rule: PreferSelfType.self, for: node)
    onVisitPost(rule: RedundantSelf.self, for: node)
  ...
  override func visitPost(_ node: OptionalTypeSyntax) {
    onVisitPost(NoOptionalBool.visitPost, for: node)
    onVisitPost(NoOptionalCollection.visitPost, for: node)
  }
  ...
  override func visitPost(_ node: ProtocolDeclSyntax) {
    onVisitPost(CapitalizeTypeNames.visitPost, for: node)
    onVisitPost(DelegateProtocolRequiresAnyObject.visitPost, for: node)
    onVisitPost(rule: DocCommentsPrecedeModifiers.self, for: node)
    onVisitPost(DocumentPublicDeclarations.visitPost, for: node)
    onVisitPost(rule: ModifiersOnSameLine.self, for: node)
    onVisitPost(NestingDepth.visitPost, for: node)
    ...
    onVisitPost(rule: TripleSlashDocComments.self, for: node)
    onVisitPost(TypeBodyLength.visitPost, for: node)
    onVisitPost(WeakDelegates.visitPost, for: node)
    onVisitPost(rule: WrapMultilineStatementBraces.self, for: node)
  }
  ...
  override func visitPost(_ node: SourceFileSyntax) {
    ...
    onVisitPost(FileLength.visitPost, for: node)
    onVisitPost(rule: FileScopedDeclarationPrivacy.self, for: node)
    onVisitPost(LineLengthLimit.visitPost, for: node)
    onVisitPost(MutableCapture.visitPost, for: node)
    onVisitPost(rule: NoForceTry.self, for: node)
    onVisitPost(rule: NoForceUnwrap.self, for: node)
    onVisitPost(rule: NoGuardInTests.self, for: node)
    onVisitPost(NoImplicitlyUnwrappedOptionals.visitPost, for: node)
  ...
  override func visitPost(_ node: StringLiteralExprSyntax) {
    onVisitPost(InvisibleCharacters.visitPost, for: node)
    onVisitPost(rule: NoForceUnwrap.self, for: node)
  }
  ...
  override func visitPost(_ node: StructDeclSyntax) {
    ...
    onVisitPost(NoLeadingUnderscores.visitPost, for: node)
    onVisitPost(rule: PreferSelfType.self, for: node)
    onVisitPost(PreferSynthesizedInitializer.visitPost, for: node)
    onVisitPost(rule: RedundantAccessControl.self, for: node)
  ...
  override func visitPost(_ node: TokenSyntax) {
    ...
    onVisitPost(ExpiringTodo.visitPost, for: node)
    onVisitPost(rule: FormatSpecialComments.self, for: node)
    onVisitPost(rule: LeadingDotOperators.self, for: node)
    onVisitPost(NoBlockComments.visitPost, for: node)
    onVisitPost(OrphanedDocComment.visitPost, for: node)
    onVisitPost(PreferWeakCapture.visitPost, for: node)
  ...
  override func visitPost(_ node: TupleTypeSyntax) {
    onVisitPost(TupleSize.visitPost, for: node)
  }
  ...
  override func visitPost(_ node: VariableDeclSyntax) {
    ...
    onVisitPost(rule: ModifiersOnSameLine.self, for: node)
    onVisitPost(NoImplicitlyUnwrappedOptionals.visitPost, for: node)
    onVisitPost(NoTypeRepetitionInStaticProperties.visitPost, for: node)
