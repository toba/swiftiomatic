...
extension ExprSyntax {
  ...
  package var asFunctionCall: FunctionCallExprSyntax? {
...
extension StringLiteralExprSyntax {
  package var isEmptyString: Bool {
...
extension ClosureCaptureSyntax {
  ...
  package var capturesSelf: Bool {
    name.text == "self"
  }

  /// Whether this capture uses the `weak` specifier
  package var capturesWeakly: Bool {
...
extension TypeSyntax {
  ...
  package var isOptionalType: Bool {
