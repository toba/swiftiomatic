...
public final class RuleStorage: CustomStringConvertible, Sendable {
  ...
  package func collect<R: CollectingRule>(info: R.FileInfo, for file: SwiftSource, in _: R) {
  ...
  package func collectedInfo<R: CollectingRule>(for _: R) -> [SwiftSource: R.FileInfo]? {
    storage.withLock { box in
