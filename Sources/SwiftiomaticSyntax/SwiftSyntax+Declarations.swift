...
extension ClassDeclSyntax {
  ...
  package func isXCTestCase(_ testParentClasses: Set<String>) -> Bool {
...
extension DeclModifierListSyntax {
  ...
  package var containsStaticOrClass: Bool {
  ...
  package func containsPrivateOrFileprivate(setOnly: Bool = false) -> Bool {
  ...
  package var accessibility: AccessControlLevel? {
  ...
  package var accessLevelModifier: DeclModifierSyntax? {
  ...
  package func accessLevelModifier(setter: Bool = false) -> DeclModifierSyntax? {
    first {
  ...
  package func contains(keyword: Keyword) -> Bool {
...
extension DeclModifierSyntax {
  ...
  package var asAccessLevelModifier: TokenKind? {
...
extension AttributeListSyntax {
  ...
  package func contains(attributeNamed attributeName: String) -> Bool {
...
extension VariableDeclSyntax {
  ...
  package var isInstanceVariable: Bool {
...
extension EnumDeclSyntax {
  ...
  package var supportsRawValues: Bool {
  ...
  package var definesCodingKeys: Bool {
...
extension FunctionDeclSyntax {
  ...
  package func numberOfCallsToSuper() -> Int {
    guard let body else {
      return 0
    }
...
extension InheritanceClauseSyntax? {
  ...
  package func containsInheritedType(inheritedTypes: Set<String>) -> Bool {
