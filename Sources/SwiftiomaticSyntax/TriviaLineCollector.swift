...
package enum TriviaLineCollector {
  ...
  package struct Result {
    ...
    package var maxNewlineLine: Int?

    package init(commentLines: Set<Int> = Set<Int>(), maxNewlineLine: Int? = nil) {
      self.commentLines = commentLines
      self.maxNewlineLine = maxNewlineLine
    }
  }
  ...
  package static func collectLines(
    from trivia: Trivia,
