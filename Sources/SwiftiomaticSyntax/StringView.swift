...
package struct StringView {
  ...
  package let utf8View: String.UTF8View
  /// Cached UTF-16 view for `NSRange` calculations
  package let utf16View: String.UTF16View
  ...
  package init(_ nsstring: NSString) {
  ...
  package func substring(with range: NSRange) -> String {
  ...
  package func substringWithByteRange(_ byteRange: ByteRange) -> String? {
  ...
  package func byteRangeToNSRange(_ byteRange: ByteRange) -> NSRange? {
  ...
  /// - Parameters:
  ///   - byteRange: The byte range to convert.
  package func byteRangeToStringRange(_ byteRange: ByteRange) -> Range<String.Index>? {
    guard !string.isEmpty else { return nil }
  ...
  package func stringRangeToByteRange(_ range: Range<String.Index>) -> ByteRange {
  ...
  package func byteOffset(fromLocation location: Int) -> ByteCount {
  ...
  package func NSRangeToByteRange(start: Int, length: Int) -> ByteRange? {
  ...
  package func NSRangeToByteRange(_ range: NSRange) -> ByteRange? {
  ...
  package func location(fromByteOffset byteOffset: ByteCount) -> Int {
    if lines.isEmpty { return 0 }
    let index = lines.indexAssumingSorted { line in
  ...
  package func substringStartingLinesWithByteRange(_ byteRange: ByteRange) -> String? {
  ...
  /// - Parameters:
  ///   - byteRange: The byte range whose enclosing lines to extract.
  package func substringLinesWithByteRange(_ byteRange: ByteRange) -> String? {
    byteRangeToNSRange(byteRange).map { range in
      var lineStart = 0
      var lineEnd = 0
      nsString.getLineStart(&lineStart, end: &lineEnd, contentsEnd: nil, for: range)
  ...
  package func lineRangeWithByteRange(_ byteRange: ByteRange) -> (start: Int, end: Int)? {
  ...
  package func lineAndCharacter(forByteOffset offset: ByteCount, expandingTabsToWidth tabWidth: Int = 1)
