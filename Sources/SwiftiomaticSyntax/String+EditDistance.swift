...
extension Array where Element: Equatable {
  ...
  package func formattedList(default defaultValue: Element? = nil) -> String
  ...
  package func formattedList(default: Element? = nil) -> String {
    if let `default` {
...
extension Array where Element: StringProtocol {
  ...
  package func formattedList(lastSeparator: String) -> String {
    switch count {
    case 0:
      return ""
    case 1:
...
extension String {
  ...
  package func bestMatch(in options: [String]) -> String? {
  ...
  package func bestMatches(in options: [String]) -> [String] {
  ...
  package func editDistance(from other: String) -> Int {
    let lhs = Array(self)
    let rhs = Array(other)
...
extension String {
  ...
  package var commaDelimitedItems: [String] {
...
package func parseCommaDelimitedList(_ string: String) -> [String] {
