...
extension Collection {
  ...
  package func windows(ofCount count: Int) -> WindowsOfCountCollection<Self> {
...
/// a collection.
package struct WindowsOfCountCollection<Base: Collection> {
  package let base: Base
  package let windowSize: Int
  package var endOfFirstWindow: Base.Index?

  package init(base: Base, windowSize: Int) {
...
extension WindowsOfCountCollection: Collection {
  ...
  package struct Index: Comparable {
    package var lowerBound: Base.Index
    package var upperBound: Base.Index
  ...
  package subscript(index: Index) -> Base.SubSequence {
    precondition(
  ...
  func offsetForward(_ i: Index, by distance: Int) -> Index {
    guard let index = offsetForward(i, by: distance, limitedBy: endIndex)
    else { fatalError("Index is out of bounds") }
    return index
  }

  func offsetBackward(_ i: Index, by distance: Int) -> Index {
