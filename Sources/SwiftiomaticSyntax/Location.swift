...
package struct Location: CustomStringConvertible, Comparable, Codable, Sendable {
  ...
  package var relativeFile: String? {
  ...
  package init(file: String?, line: Int? = nil, column: Int? = nil) {
    self.file = file
    self.line = line
    self.column = column
  }
  ...
  package init(file: SwiftSource, byteOffset offset: ByteCount) {
    self.file = file.path
  ...
  package init(file: SwiftSource, position: AbsolutePosition) {
  ...
  package init(file: SwiftSource, characterOffset offset: Int) {
    self.file = file.path
  ...
  package init(file: SwiftSource, stringIndex index: String.Index) {
