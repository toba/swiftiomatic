...
package struct Command: Equatable {
  ...
  package let ruleIdentifiers: Set<RuleIdentifier>
  ...
  package let trailingComment: String?
  ...
  ///   - line: The line in the source file where this command is defined.
  ///   - range: The range of the command in the line (0-based).
  package init(commandString: String, line: Int, range: Range<Int>) {
