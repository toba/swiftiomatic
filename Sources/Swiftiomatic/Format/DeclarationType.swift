    ...
    func declarationType(
        ...
        switch kind {
            ...
            case .declaration:
                ...
                let isStaticDeclaration =
                    formatter.lastIndex(
                        of: .keyword("static"),
                        in: rangeBeforeKeyword,
                    ) != nil

                let isClassDeclaration =
                    formatter.lastIndex(
                        of: .keyword("class"),
                        in: rangeBeforeKeyword,
                    ) != nil

                let isOverriddenDeclaration =
                    formatter.lastIndex(
                ...
                let isViewDeclaration: Bool = {
                    guard
                        let someKeywordIndex = formatter.index(
                    ...
                    return formatter.index(
                        of: .identifier("View"),
                        in: someKeywordIndex ..< range.upperBound,
                    )
                        != nil
                }()
                ...
                switch keyword {
                    ...
                    case "let", "var", "operator", "precedencegroup":
                        ...
                        if isStaticDeclaration, isPropertyWithBody,
                           availableTypes.contains(.staticPropertyWithBody)
                        {
                        ...
                        if !isPropertyWithBody, isSwiftUIPropertyWrapper,
                           availableTypes.contains(.swiftUIPropertyWrapper)
                        {
