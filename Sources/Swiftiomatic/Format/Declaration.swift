...
extension Declaration {
    ...
    var modifiers: [String] {
        ...
        _ = formatter.modifiersForDeclaration(
            at: keywordIndex,
...
final class TypeDeclaration: Declaration {
    ...
    func updateBody(to newBody: [Declaration]) {
        ...
        var childDeclarationsNeedingUpdate = [
            AnyHashable: (originalIndexInParent: Int, originalTokens: [Token])
        ]()
    ...
    func declaration(containing index: Int) -> Declaration? {
        ...
        forEachRecursiveDeclaration { declaration in
            ...
            if let outer = containingDeclaration?.range {
                let containsInner =
                    outer.lowerBound <= declaration.range.lowerBound
