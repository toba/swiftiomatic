...
public final class WrapMultilineStatementBraces: SyntaxFormatRule {
  ...
  public override func visit(_ node: GuardStmtSyntax) -> StmtSyntax {
    ...
    result.elseKeyword = result.elseKeyword.with(
      \.trailingTrivia, result.elseKeyword.trailingTrivia.trimmingTrailingWhitespace)
  ...
  public override func visit(_ node: ForStmtSyntax) -> StmtSyntax {
    ...
    if let whereClause = result.whereClause {
      result.whereClause = whereClause.with(
        \.trailingTrivia, whereClause.trailingTrivia.trimmingTrailingWhitespace)
    } else {
      result.sequence = result.sequence.with(
        \.trailingTrivia, result.sequence.trailingTrivia.trimmingTrailingWhitespace)
    }
    return StmtSyntax(result)
  }
  ...
  public override func visit(_ node: DoStmtSyntax) -> StmtSyntax {
    ...
    result.doKeyword = result.doKeyword.with(
      \.trailingTrivia, result.doKeyword.trailingTrivia.trimmingTrailingWhitespace)
    return StmtSyntax(result)
  }
  ...
  public override func visit(_ node: SwitchExprSyntax) -> ExprSyntax {
    ...
    result.subject = result.subject.with(
      \.trailingTrivia, result.subject.trailingTrivia.trimmingTrailingWhitespace)
    return ExprSyntax(result)
  }
  ...
  public override func visit(_ node: FunctionDeclSyntax) -> DeclSyntax {
    ...
    if let whereClause = result.genericWhereClause {
      ...
      result.signature = result.signature.with(
        \.trailingTrivia, result.signature.trailingTrivia.trimmingTrailingWhitespace)
    }
  ...
  public override func visit(_ node: DeinitializerDeclSyntax) -> DeclSyntax {
    ...
    result.deinitKeyword = result.deinitKeyword.with(
      \.trailingTrivia, result.deinitKeyword.trailingTrivia.trimmingTrailingWhitespace)
    return DeclSyntax(result)
  }
