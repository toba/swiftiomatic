...
private enum QuickCallKind: String {
  ...
  case afterEach
  case afterSuite
  case it  // sm:disable:this identifier_name
  case pending
  case xdescribe
  case xcontext
  case xit
...
extension Stack where Element == ScopeElement {
  fileprivate func lastSuspiciousScope(_ node: any SyntaxProtocol) -> ScopeElement {
...
extension SyntaxViolation {
  fileprivate static func violation(at position: AbsolutePosition, kind: QuickCallKind) -> Self {
