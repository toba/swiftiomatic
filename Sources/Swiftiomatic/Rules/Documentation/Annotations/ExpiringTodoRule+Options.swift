struct ExpiringTodoOptions: RuleOptions {
  ...
  @OptionElement(key: "approaching_expiry_severity")
  private(set) var approachingExpirySeverity = Severity(.warning)
  @OptionElement(key: "expired_severity")
  private(set) var expiredSeverity = Severity(.error)
  @OptionElement(key: "bad_formatting_severity")
