...
extension VariableDeclSyntax {
  fileprivate var containsSwiftUIStateAccessLevelViolation: Bool {
    attributes.hasStateAttribute && !modifiers.containsPrivateOrFileprivate()
  }
}

extension InheritanceClauseSyntax? {
  fileprivate static let applicableSwiftUIProtocols: Set<String> = [
    "View", "ViewModifier", "App", "Scene",
  ]

  fileprivate var conformsToApplicableSwiftUIProtocol: Bool {
...
extension InheritedTypeListSyntax {
  fileprivate func containsInheritedType(inheritedTypes: Set<String>) -> Bool {
    contains {
...
extension AttributeListSyntax {
  ...
  fileprivate var hasStateAttribute: Bool {
    contains { attr in
