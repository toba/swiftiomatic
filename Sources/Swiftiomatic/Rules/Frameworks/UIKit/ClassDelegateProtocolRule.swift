...
struct ClassDelegateProtocolRule {
    static let id = "class_delegate_protocol"
    static let name = "Class Delegate Protocol"
    static let summary = "Delegate protocols should be class-only so they can be weakly referenced"
