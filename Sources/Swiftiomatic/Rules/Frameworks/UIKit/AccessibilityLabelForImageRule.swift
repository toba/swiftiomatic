...
struct AccessibilityLabelForImageRule {
    static let id = "accessibility_label_for_image"
...
extension FunctionCallExprSyntax {
  ...
  fileprivate var isDirectImageCall: Bool {
  ...
  fileprivate var isDecorativeOrLabeledImage: Bool {
  ...
  fileprivate func isExemptedByAncestors() -> Bool {
  ...
  fileprivate func isContainerView() -> Bool {
  ...
  fileprivate func hasAccessibilityModifiersInChain() -> Bool {
    var currentNode: Syntax? = Syntax(self)
    var depth = 0
  ...
  fileprivate func isDirectAccessibilityModifier(_ name: String) -> Bool {
    switch name {
  ...
  fileprivate func isContainerExemptingModifier(_ name: String) -> Bool {
  ...
  fileprivate func isInherentlyExemptingContainer() -> Bool {
