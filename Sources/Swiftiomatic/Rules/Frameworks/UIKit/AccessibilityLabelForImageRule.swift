...
extension FunctionCallExprSyntax {
    ...
    private func isContainerView() -> Bool {
    ...
    private func hasAccessibilityModifiersInChain() -> Bool {
        var currentNode: Syntax? = Syntax(self)
        var depth = 0
    ...
    private func isDirectAccessibilityModifier(_ name: String) -> Bool {
        switch name {
    ...
    private func isContainerExemptingModifier(_ name: String) -> Bool {
    ...
    private func isInherentlyExemptingContainer() -> Bool {
