...
extension SwiftSource {
  ...
  fileprivate func getImportsAndUSRFragments(compilerArguments: [String]) -> (
  ...
  fileprivate func rangedAndSortedUnusedImports(of unusedImports: [String]) -> [(String, NSRange)] {
  ...
  fileprivate func flatEntities(entity: SourceKitDictionary) -> [SourceKitDictionary] {
  ...
  fileprivate func mightBeOperator(kind: String?) -> Bool {
  ...
  fileprivate func appendUsedImports(
  ...
  fileprivate func containsAttributesRequiringFoundation() -> Bool {
