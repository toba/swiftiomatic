...
struct EmptyCountRule {
  ...
  static let name = "Empty Count"
  static let summary = "Prefer checking `isEmpty` over comparing `count` to zero"
  ...
  fileprivate final class Rewriter: ViolationCollectingRewriter<OptionsType> {
    override func visit(_ node: InfixOperatorExprSyntax) -> ExprSyntax {
        ...
        .countNodeAndPosition(onlyAfterDot: configuration.onlyAfterDot)
      {
        ...
        return if ["!=", "<", ">"].contains(binaryOperator) {
          newNode.negated
...
extension ExprSyntax {
  private var isNonLocalCountIdentifier: Bool {
