...
extension InitializerDeclSyntax {
    fileprivate var hasThrowsOrRethrowsKeyword: Bool {
        signature.effectSpecifiers?.throwsClause?.throwsSpecifier != nil
    }

    fileprivate var parameterList: FunctionParameterListSyntax {
...
extension VariableDeclSyntax {
    private var identifiers: [IdentifierPatternSyntax] {
