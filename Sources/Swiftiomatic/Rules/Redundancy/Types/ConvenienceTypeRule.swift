...
struct ConvenienceTypeRule {
    static let id = "convenience_type"
    static let name = "Convenience Type"
    static let summary = "Types used for hosting only static members should be implemented as a caseless enum to avoid instantiation"
