enum TypeNameRuleExamples {
  static let nonTriggeringExamples: [Example] = [
    ...
    Example("struct MyView_Previews: PreviewProvider", isExcludedFromDocumentation: true),
    Example("private class _MyView_Previews: PreviewProvider", isExcludedFromDocumentation: true),
  ...
  static let triggeringExamples: [Example] = [
    ...
    Example("private class ↓`_` {}", isExcludedFromDocumentation: true),
    Example("struct ↓My {}"),
