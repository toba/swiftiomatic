...
struct GenericTypeNameRule {
    static let id = "generic_type_name"
    static let name = "Generic Type Name"
    static let summary = "Generic type name should only contain alphanumeric characters, start with an uppercase character and span between 1 and 20 characters in length."
