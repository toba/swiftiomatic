...
struct DeploymentTargetOptions: SeverityBasedRuleOptions {
  ...
  enum Platform: String {
    ...
    var appExtensionCounterpart: WritableKeyPath<DeploymentTargetOptions, Version>? {
      switch self {
      case .iOS: \DeploymentTargetOptions.iOSAppExtensionDeploymentTarget
      case .macOS: \DeploymentTargetOptions.macOSAppExtensionDeploymentTarget
      case .watchOS: \DeploymentTargetOptions.watchOSAppExtensionDeploymentTarget
      case .tvOS: \DeploymentTargetOptions.tvOSAppExtensionDeploymentTarget
      default: nil
      }
    }
  }
  ...
  struct Version: Equatable, Comparable {
    ...
    private static func parseVersion(string: String) throws(SwiftiomaticError)
      -> (Int, Int, Int)
    {
