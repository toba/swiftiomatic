...
struct LegacyObjcTypeRule {
    static let id = "legacy_objc_type"
    static let name = "Legacy Objective-C Reference Type"
    static let summary = "Prefer Swift value types to bridged Objective-C reference types"
