...
extension FunctionCallExprSyntax {
  ...
  fileprivate var isTaskWithImplicitErrorType: Bool {
  ...
  fileprivate var isAssigned: Bool {
  ...
  fileprivate var isValueOrResultAccessed: Bool {
...
extension SyntaxProtocol {
  fileprivate var isExplicitReturnValue: Bool {
    parent?.is(ReturnStmtSyntax.self) == true
  }

  fileprivate var isImplicitReturnValue: Bool {
