...
extension TypeSyntax {
  fileprivate var asyncToken: TokenSyntax? {
...
extension WithModifiersSyntax where Self: WithAttributesSyntax {
  fileprivate var needsToKeepAsync: Bool {
