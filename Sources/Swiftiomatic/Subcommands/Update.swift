...
extension SwiftiomaticCommand {
    struct Update: ParsableCommand {
        ...
        func run() throws {
            ...
            guard case let .object(rootDict) = rootValue else {
        ...
        /// Encodes a default Configuration to a `JSONValue` dict so additions can pull canonical
        /// default values for newly-recognized rules.
