...
private class RuleStatusCollectionVisitor: SyntaxVisitor {
  ...
  nonisolated(unsafe) private static let ignoreRegex: IgnoreDirective.RegexExpression = IgnoreDirective.node.makeRegex()

  /// Cached regex object for ignoring rules at the file.
  nonisolated(unsafe) private static let ignoreFileRegex: IgnoreDirective.RegexExpression = IgnoreDirective.file.makeRegex()
