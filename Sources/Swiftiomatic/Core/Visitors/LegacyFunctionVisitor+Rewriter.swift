...
class LegacyFunctionVisitor<Configuration: RuleConfiguration>: ViolationsSyntaxVisitor<Configuration> {
...
class LegacyFunctionRewriter<Configuration: RuleConfiguration>: ViolationsSyntaxRewriter<Configuration> {
    @usableFromInline let legacyFunctions: [String: LegacyFunctionRewriteStrategy]
