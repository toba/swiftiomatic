...
macro AutoConfigParser() = #externalMacro(
...
macro AcceptableByConfigurationElement() = #externalMacro(
    module: "SwiftLintCoreMacros",
...
macro DisabledWithoutSourceKit() = #externalMacro(
    module: "SwiftLintCoreMacros",
...
macro MakeAcceptableByConfigurationElement() = #externalMacro(
    module: "SwiftLintCoreMacros",
    type: "AcceptableByConfigurationElement"
)
...
macro SwiftSyntaxRule(foldExpressions: Bool = false,
