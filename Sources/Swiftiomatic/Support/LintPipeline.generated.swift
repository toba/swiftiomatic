...
final class LintPipeline: SyntaxVisitor {
  ...
  private var memberBlockItem_visitPost: [Int] = []
  ...
  override func visitPost(_ node: MemberBlockItemSyntax) {
    for idx in memberBlockItem_visitPost where skipDepths[idx] == 0 {
      visitors[idx].visitPost(node)
    }
  }
