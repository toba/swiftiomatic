...
protocol Rule: Sendable {
    ...
    ///
    /// - returns: All style violations to the rule's expectations.
    func validate(file: SwiftLintFile, using storage: RuleStorage, compilerArguments: [String])
        -> [StyleViolation]
...
extension Rule {
    ...
    func validate(file: SwiftLintFile, using _: RuleStorage, compilerArguments: [String])
        -> [StyleViolation]
    {
...
protocol ConditionallySourceKitFree: Rule {
