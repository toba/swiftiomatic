...
struct Location: CustomStringConvertible, Comparable, Codable, Sendable {
    ...
    init(file: SwiftLintFile, byteOffset offset: ByteCount) {
        self.file = file.path
    ...
    init(file: SwiftLintFile, position: AbsolutePosition) {
    ...
    init(file: SwiftLintFile, characterOffset offset: Int) {
        self.file = file.path
