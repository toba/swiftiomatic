...
final class PerformanceAntiPatternsCheck: BaseCheck {
    ...
    override func visit(_ node: FunctionCallExprSyntax) -> SyntaxVisitorContinueKind {
        ...
        if callee == "Date" || callee == "Date.init" {
            // Check if it's likely benchmarking by looking at context
    ...
    override func visit(_ node: ForStmtSyntax) -> SyntaxVisitorContinueKind {
        ...
        if mutationFinder.foundMutation {
            addFinding(
                ...
                category: .performanceAntiPatterns,
                severity: .high,
                message: "Collection '\(collectionName)' is mutated during iteration — may crash or skip elements",
    ...
    override func visit(_ node: ArrayExprSyntax) -> SyntaxVisitorContinueKind {
        ...
        // Check if this is an argument to a function call
...
/// Finds mutations on a named collection inside a for-in body.
private final class MutationDuringIterationFinder: SyntaxVisitor {
